...
public class FencedCodeBlockParser extends AbstractBlockParser {
    ...
    public static class Factory extends AbstractBlockParserFactory {
        ...
        public BlockStart tryStart(ParserState parserState, MatchedBlockParser matchedBlockParser) {
            ...
            if (fencedCodeBlockParserCheckOpener != null) {
                return BlockStart.m1931of(fencedCodeBlockParserCheckOpener).atIndex(nextNonSpaceIndex + fencedCodeBlockParserCheckOpener.block.getFenceLength());
            }
            return BlockStart.none();
        }
    }
    ...
    public static FencedCodeBlockParser checkOpener(CharSequence charSequence, int i, int i2) {
        ...
        return new FencedCodeBlockParser(JsonPointer.ESC, i4, i2);
    }
