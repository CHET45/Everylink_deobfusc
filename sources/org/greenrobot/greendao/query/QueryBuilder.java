...
import org.greenrobot.greendao.p040rx.RxQuery;
...
public class QueryBuilder<T> {
    ...
    private void checkOrderBuilder() {
        ...
        if (sb == null) {
            ...
            this.orderBuilder.append(PunctuationConst.COMMA);
        }
    }
    ...
    public QueryBuilder<T> whereOr(WhereCondition whereCondition, WhereCondition whereCondition2, WhereCondition... whereConditionArr) {
        this.whereCollector.add(m1953or(whereCondition, whereCondition2, whereConditionArr), new WhereCondition[0]);
        return this;
    }

    /* JADX INFO: renamed from: or */
    public WhereCondition m1953or(WhereCondition whereCondition, WhereCondition whereCondition2, WhereCondition... whereConditionArr) {
    ...
    protected StringBuilder append(StringBuilder sb, Property property) {
        ...
        sb.append(this.tablePrefix).append(CharConst.DOT).append('\'').append(property.columnName).append('\'');
        return sb;
    }
    ...
    public DeleteQuery<T> buildDelete() {
        ...
        appendJoinsAndWheres(sb, this.tablePrefix);
        String strReplace = sb.toString().replace(this.tablePrefix + ".\"", PunctuationConst.DOUBLE_QUOTES + tablename + "\".\"");
        checkLog(strReplace);
    ...
    private void checkLog(String str) {
        if (LOG_SQL) {
            DaoLog.m1933d("Built SQL for query: " + str);
        }
        if (LOG_VALUES) {
            DaoLog.m1933d("Values for query: " + this.values);
        }
    }
