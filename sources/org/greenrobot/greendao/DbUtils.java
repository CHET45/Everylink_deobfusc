...
public class DbUtils {
    ...
    public static int executeSqlScript(Context context, Database database, String str, boolean z) throws IOException {
        ...
        DaoLog.m1937i("Executed " + iExecuteSqlStatements + " statements from SQL script '" + str + PunctuationConst.SINGLE_QUOTES);
    ...
    public static void logTableDump(SQLiteDatabase sQLiteDatabase, String str) {
        ...
        try {
            DaoLog.m1933d(DatabaseUtils.dumpCursorToString(cursorQuery));
        } finally {
            cursorQuery.close();
        }
    }
