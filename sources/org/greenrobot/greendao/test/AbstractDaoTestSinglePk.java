...
public abstract class AbstractDaoTestSinglePk<D extends AbstractDao<T, K>, T, K> extends AbstractDaoTest<D, T, K> {
    ...
    protected Cursor queryWithDummyColumnsInFront(int i, String str, K k) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            sb.append(str).append(PunctuationConst.COMMA);
        }
        ...
        if (k != null) {
            ...
            sb.append(this.dao.getPkColumns()[0]).append(PunctuationConst.EQUAL);
            DatabaseUtils.appendValueToSql(sb, k);
        }
        Cursor cursorRawQuery = this.f2042db.rawQuery(sb.toString(), null);
    ...
    protected boolean checkKeyIsNullable() {
        ...
        DaoLog.m1933d("Test is not available for entities with non-null keys");
        return false;
    }
