...
public abstract class AbstractDaoTest<D extends AbstractDao<T, K>, T, K> extends DbTest {
    ...
    protected void setUp() throws Exception {
        ...
        try {
            setUpTableForDao();
            InternalUnitTestDaoAccess<T, K> internalUnitTestDaoAccess = new InternalUnitTestDaoAccess<>(this.f2042db, this.daoClass, this.identityScopeForDao);
    ...
    protected void setUpTableForDao() throws Exception {
        try {
            this.daoClass.getMethod("createTable", Database.class, Boolean.TYPE).invoke(null, this.f2042db, false);
        } catch (NoSuchMethodException unused) {
            DaoLog.m1937i("No createTable method");
        }
    }
    ...
    protected void clearIdentityScopeIfAny() {
        ...
        if (identityScope != null) {
            identityScope.clear();
            DaoLog.m1933d("Identity scope cleared");
        } else {
            DaoLog.m1933d("No identity scope to clear");
        }
    }
