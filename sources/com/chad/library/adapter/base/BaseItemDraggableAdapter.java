...
public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    public void onBindViewHolder(K k, int i) {
        ...
        if (i2 != 0) {
            View view2 = k.getView(i2);
            if (view2 != null) {
                view2.setTag(C1376R.id.BaseQuickAdapter_viewholder_support, k);
        ...
        k.itemView.setTag(C1376R.id.BaseQuickAdapter_viewholder_support, k);
        ...
        if (z) {
            ...
            this.mOnToggleViewLongClickListener = new View.OnLongClickListener() { // from class: com.chad.library.adapter.base.BaseItemDraggableAdapter.1
                ...
                public boolean onLongClick(View view2) {
                    ...
                    BaseItemDraggableAdapter.this.mItemTouchHelper.startDrag((RecyclerView.ViewHolder) view2.getTag(C1376R.id.BaseQuickAdapter_viewholder_support));
                    return true;
                }
            };
        } else {
