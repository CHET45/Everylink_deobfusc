    ...
    public Bitmap decode(Context context, Uri uri) throws Exception {
        ...
        if (string.startsWith(RESOURCE_PREFIX)) {
            ...
            if (string.startsWith(ASSET_PREFIX)) {
                bitmapDecodeFile = BitmapFactory.decodeStream(context.getAssets().open(string.substring(ASSET_PREFIX.length())), null, options);
            } else if (string.startsWith(FILE_PREFIX)) {
                bitmapDecodeFile = BitmapFactory.decodeFile(string.substring(FILE_PREFIX.length()), options);
            } else {
                try {
