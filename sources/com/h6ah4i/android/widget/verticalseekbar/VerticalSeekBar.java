...
public class VerticalSeekBar extends AppCompatSeekBar {
    ...
    private void initialize(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1975R.styleable.VerticalSeekBar, i, i2);
            int integer = typedArrayObtainStyledAttributes.getInteger(C1975R.styleable.VerticalSeekBar_seekBarRotation, 0);
