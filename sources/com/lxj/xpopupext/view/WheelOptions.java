...
public class WheelOptions<T> {
    ...
    public View getView() {
        return this.f2363view;
    }

    public void setView(View view2) {
        this.f2363view = view2;
    }

    public WheelOptions(View view2, boolean z) {
        this.isRestoreItem = z;
        this.f2363view = view2;
        this.wv_option1 = (WheelView) view2.findViewById(C2296R.id.options1);
        this.wv_option2 = (WheelView) view2.findViewById(C2296R.id.options2);
        this.wv_option3 = (WheelView) view2.findViewById(C2296R.id.options3);
    }
    ...
    public void setPicker(List<T> list, List<List<T>> list2, List<List<List<T>>> list3) {
        ...
        this.wheelListener_option1 = new OnItemSelectedListener() { // from class: com.lxj.xpopupext.view.WheelOptions.1
            @Override // com.contrarywind.listener.OnItemSelectedListener
            public void onItemSelected(int i) {
                int currentItem;
                if (WheelOptions.this.mOptions2Items == null) {
                    if (WheelOptions.this.optionsSelectChangeListener != null) {
                        WheelOptions.this.optionsSelectChangeListener.onOptionsSelect(WheelOptions.this.wv_option1.getCurrentItem(), 0, 0);
                        return;
                    }
                    return;
                }
                ...
                if (WheelOptions.this.mOptions3Items != null) {
                    ...
                    WheelOptions.this.optionsSelectChangeListener.onOptionsSelect(i, currentItem, 0);
                }
            }
        };
        this.wheelListener_option2 = new OnItemSelectedListener() { // from class: com.lxj.xpopupext.view.WheelOptions.2
            @Override // com.contrarywind.listener.OnItemSelectedListener
            public void onItemSelected(int i) {
                int size = 0;
                if (WheelOptions.this.mOptions3Items != null) {
                    ...
                    if (WheelOptions.this.optionsSelectChangeListener != null) {
                        WheelOptions.this.optionsSelectChangeListener.onOptionsSelect(WheelOptions.this.wv_option1.getCurrentItem(), i, size);
                        return;
                    }
                    return;
                }
                if (WheelOptions.this.optionsSelectChangeListener != null) {
                    WheelOptions.this.optionsSelectChangeListener.onOptionsSelect(WheelOptions.this.wv_option1.getCurrentItem(), i, 0);
                }
            }
        };
        ...
        this.wv_option3.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.lxj.xpopupext.view.WheelOptions.3
            @Override // com.contrarywind.listener.OnItemSelectedListener
            public void onItemSelected(int i) {
                WheelOptions.this.optionsSelectChangeListener.onOptionsSelect(WheelOptions.this.wv_option1.getCurrentItem(), WheelOptions.this.wv_option2.getCurrentItem(), i);
            }
        });
    }
    ...
    public void setNPicker(List<T> list, List<T> list2, List<T> list3) {
        ...
        if (this.optionsSelectChangeListener != null) {
            this.wv_option1.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.lxj.xpopupext.view.WheelOptions.4
                @Override // com.contrarywind.listener.OnItemSelectedListener
                public void onItemSelected(int i) {
                    WheelOptions.this.optionsSelectChangeListener.onOptionsSelect(i, WheelOptions.this.wv_option2.getCurrentItem(), WheelOptions.this.wv_option3.getCurrentItem());
                }
            });
        }
        if (list2 == null) {
            ...
            this.wv_option2.setVisibility(0);
            if (this.optionsSelectChangeListener != null) {
                this.wv_option2.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.lxj.xpopupext.view.WheelOptions.5
                    @Override // com.contrarywind.listener.OnItemSelectedListener
                    public void onItemSelected(int i) {
                        WheelOptions.this.optionsSelectChangeListener.onOptionsSelect(WheelOptions.this.wv_option1.getCurrentItem(), i, WheelOptions.this.wv_option3.getCurrentItem());
                    }
                });
            }
        }
        ...
        this.wv_option3.setVisibility(0);
        if (this.optionsSelectChangeListener != null) {
            this.wv_option3.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.lxj.xpopupext.view.WheelOptions.6
                @Override // com.contrarywind.listener.OnItemSelectedListener
                public void onItemSelected(int i) {
                    WheelOptions.this.optionsSelectChangeListener.onOptionsSelect(WheelOptions.this.wv_option1.getCurrentItem(), WheelOptions.this.wv_option2.getCurrentItem(), i);
                }
    ...
    public void setOptionsSelectChangeListener(OnOptionsSelectListener onOptionsSelectListener) {
        this.optionsSelectChangeListener = onOptionsSelectListener;
    }
