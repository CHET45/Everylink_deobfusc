...
public class WheelTime {
    ...
    private void setLunar(int i, int i2, int i3, boolean z, int i4, int i5, int i6) {
        WheelView wheelView = (WheelView) this.f2364view.findViewById(C2296R.id.year);
        ...
        WheelView wheelView2 = (WheelView) this.f2364view.findViewById(C2296R.id.month);
        ...
        this.wv_day = (WheelView) this.f2364view.findViewById(C2296R.id.day);
        ...
        WheelView wheelView3 = (WheelView) this.f2364view.findViewById(C2296R.id.hour);
        this.wv_hours = wheelView3;
        wheelView3.setAdapter(new NumericWheelAdapter(0, 23));
        this.wv_hours.setCurrentItem(i4);
        this.wv_hours.setGravity(this.gravity);
        WheelView wheelView4 = (WheelView) this.f2364view.findViewById(C2296R.id.min);
        ...
        WheelView wheelView5 = (WheelView) this.f2364view.findViewById(C2296R.id.second);
        ...
        this.wv_year.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.lxj.xpopupext.view.WheelTime.1
        ...
        this.wv_month.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.lxj.xpopupext.view.WheelTime.2
            @Override // com.contrarywind.listener.OnItemSelectedListener
            public void onItemSelected(int i7) {
                int iMonthDays;
    ...
    private void setSolar(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        this.wv_month.setGravity(this.gravity);
        this.wv_day = (WheelView) this.f2364view.findViewById(C2296R.id.day);
        boolean z = (i % 4 == 0 && i % 100 != 0) || i % Constant.EVENT.BLE_GLASS_ASK_AI == 0;
        ...
        this.wv_seconds.setGravity(this.gravity);
        this.wv_year.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.lxj.xpopupext.view.WheelTime.3
            @Override // com.contrarywind.listener.OnItemSelectedListener
        ...
        this.wv_month.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.lxj.xpopupext.view.WheelTime.4
            @Override // com.contrarywind.listener.OnItemSelectedListener
            public void onItemSelected(int i15) {
                int i16 = i15 + 1;
                if (WheelTime.this.startYear == WheelTime.this.endYear) {
    ...
    public void setReDay(int i, int i2, int i3, int i4, List<String> list, List<String> list2) {
        ...
        if (list.contains(String.valueOf(i2))) {
            ...
            this.wv_day.setAdapter(new NumericWheelAdapter(i3, i4));
        } else if ((i % 4 == 0 && i % 100 != 0) || i % Constant.EVENT.BLE_GLASS_ASK_AI == 0) {
            if (i4 > 29) {
                i4 = 29;
            }
            this.wv_day.setAdapter(new NumericWheelAdapter(i3, i4));
    ...
    public void setLabels(String str, String str2, String str3, String str4, String str5, String str6) {
        ...
        if (str != null) {
            ...
            this.wv_year.setLabel(this.f2364view.getContext().getString(C2296R.string._xpopup_ext_year));
        }
        if (str2 != null) {
            this.wv_month.setLabel(str2);
        } else {
            this.wv_month.setLabel(this.f2364view.getContext().getString(C2296R.string._xpopup_ext_month));
        }
        if (str3 != null) {
            this.wv_day.setLabel(str3);
        } else {
            this.wv_day.setLabel(this.f2364view.getContext().getString(C2296R.string._xpopup_ext_day));
        }
        if (str4 != null) {
            this.wv_hours.setLabel(str4);
        } else {
            this.wv_hours.setLabel(this.f2364view.getContext().getString(C2296R.string._xpopup_ext_hours));
        }
        if (str5 != null) {
            this.wv_minutes.setLabel(str5);
        } else {
            this.wv_minutes.setLabel(this.f2364view.getContext().getString(C2296R.string._xpopup_ext_minutes));
        }
        if (str6 != null) {
            this.wv_seconds.setLabel(str6);
        } else {
            this.wv_seconds.setLabel(this.f2364view.getContext().getString(C2296R.string._xpopup_ext_seconds));
        }
    }
    ...
    private String getLunarTime() {
        ...
        if (ChinaDate.leapMonth(currentItem2) == 0 || (this.wv_month.getCurrentItem() + 1) - ChinaDate.leapMonth(currentItem2) <= 0) {
            ...
            sb.append(iArrLunarToSolar[0]).append("-").append(iArrLunarToSolar[1]).append("-").append(iArrLunarToSolar[2]).append(" ").append(this.wv_hours.getCurrentItem()).append(":").append(this.wv_minutes.getCurrentItem()).append(":").append(this.wv_seconds.getCurrentItem());
            return sb.toString();
        }
        if ((this.wv_month.getCurrentItem() + 1) - ChinaDate.leapMonth(currentItem2) == 1) {
            ...
            sb.append(iArrLunarToSolar2[0]).append("-").append(iArrLunarToSolar2[1]).append("-").append(iArrLunarToSolar2[2]).append(" ").append(this.wv_hours.getCurrentItem()).append(":").append(this.wv_minutes.getCurrentItem()).append(":").append(this.wv_seconds.getCurrentItem());
            return sb.toString();
        }
        currentItem = this.wv_month.getCurrentItem();
        z = false;
        int[] iArrLunarToSolar22 = LunarCalendar.lunarToSolar(currentItem2, currentItem, this.wv_day.getCurrentItem() + 1, z);
        sb.append(iArrLunarToSolar22[0]).append("-").append(iArrLunarToSolar22[1]).append("-").append(iArrLunarToSolar22[2]).append(" ").append(this.wv_hours.getCurrentItem()).append(":").append(this.wv_minutes.getCurrentItem()).append(":").append(this.wv_seconds.getCurrentItem());
        return sb.toString();
    }

    public View getView() {
        return this.f2364view;
    }
