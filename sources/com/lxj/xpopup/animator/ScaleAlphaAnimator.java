...
public class ScaleAlphaAnimator extends PopupAnimator {
    ...
    public ScaleAlphaAnimator(View view2, int i, PopupAnimation popupAnimation) {
        super(view2, i, popupAnimation);
        this.startScale = 0.75f;
    }
    ...
    /* JADX INFO: renamed from: com.lxj.xpopup.animator.ScaleAlphaAnimator$3 */
    static /* synthetic */ class C22203 {
    ...
    public void applyPivot() {
        int i = C22203.$SwitchMap$com$lxj$xpopup$enums$PopupAnimation[this.popupAnimation.ordinal()];
        if (i == 1) {
