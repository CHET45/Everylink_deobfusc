...
public final class FuckRomUtils {
    ...
    public static RomInfo getRomInfo() throws Throwable {
        ...
        if (isRightRom(brand, manufacturer, strArr)) {
            ...
            String[] strArrSplit = romVersion.split(PunctuationConst.UNDERLINE);
    ...
    public static class RomInfo {
        ...
        public String toString() {
            return "RomInfo{name=" + this.name + ", version=" + this.version + PlaceholderUtil.DEFAULT_PLACEHOLDER_SUFFIX;
        }
    }
}
