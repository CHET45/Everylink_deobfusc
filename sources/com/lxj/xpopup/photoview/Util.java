...
class Util {
    ...
    /* JADX INFO: renamed from: com.lxj.xpopup.photoview.Util$1 */
    ...
    static boolean isSupportedScaleType(ImageView.ScaleType scaleType) {
        return (scaleType == null || C22721.$SwitchMap$android$widget$ImageView$ScaleType[scaleType.ordinal()] == 1) ? false : true;
    }
}
