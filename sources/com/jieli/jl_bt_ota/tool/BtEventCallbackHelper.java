...
public class BtEventCallbackHelper extends BaseCallbackHelper<IBluetoothCallback> implements IBluetoothCallback {
    ...
    public void onA2dpStatus(final BluetoothDevice bluetoothDevice, final int i) {
        callbackEvent(new ICallbackHandler() { // from class: com.jieli.jl_bt_ota.tool.BtEventCallbackHelper$$ExternalSyntheticLambda1
    ...
    public void onAdapterStatus(final boolean z, final boolean z2) {
        callbackEvent(new ICallbackHandler() { // from class: com.jieli.jl_bt_ota.tool.BtEventCallbackHelper$$ExternalSyntheticLambda4
            @Override // com.jieli.jl_bt_ota.tool.ICallbackHandler
            public final void onHandle(Object obj) {
    ...
    public void onBleDataBlockChanged(final BluetoothDevice bluetoothDevice, final int i, final int i2) {
        callbackEvent(new ICallbackHandler() { // from class: com.jieli.jl_bt_ota.tool.BtEventCallbackHelper$$ExternalSyntheticLambda2
            @Override // com.jieli.jl_bt_ota.tool.ICallbackHandler
            public final void onHandle(Object obj) {
    ...
    public void onBtDeviceConnection(final BluetoothDevice bluetoothDevice, final int i) {
        callbackEvent(new ICallbackHandler() { // from class: com.jieli.jl_bt_ota.tool.BtEventCallbackHelper$$ExternalSyntheticLambda8
            @Override // com.jieli.jl_bt_ota.tool.ICallbackHandler
            public final void onHandle(Object obj) {
    ...
    public void onConnection(final BluetoothDevice bluetoothDevice, final int i) {
        callbackEvent(new ICallbackHandler() { // from class: com.jieli.jl_bt_ota.tool.BtEventCallbackHelper$$ExternalSyntheticLambda3
            @Override // com.jieli.jl_bt_ota.tool.ICallbackHandler
            public final void onHandle(Object obj) {
    ...
    public void onDiscovery(final BluetoothDevice bluetoothDevice, final BleScanMessage bleScanMessage) {
        callbackEvent(new ICallbackHandler() { // from class: com.jieli.jl_bt_ota.tool.BtEventCallbackHelper$$ExternalSyntheticLambda0
            @Override // com.jieli.jl_bt_ota.tool.ICallbackHandler
            public final void onHandle(Object obj) {
    ...
    public void onDiscoveryStatus(final boolean z, final boolean z2) {
        callbackEvent(new ICallbackHandler() { // from class: com.jieli.jl_bt_ota.tool.BtEventCallbackHelper$$ExternalSyntheticLambda7
            @Override // com.jieli.jl_bt_ota.tool.ICallbackHandler
            public final void onHandle(Object obj) {
    ...
    public void onError(final BaseError baseError) {
        callbackEvent(new ICallbackHandler() { // from class: com.jieli.jl_bt_ota.tool.BtEventCallbackHelper$$ExternalSyntheticLambda9
            @Override // com.jieli.jl_bt_ota.tool.ICallbackHandler
            public final void onHandle(Object obj) {
                ((IBluetoothCallback) obj).onError(baseError);
            }
        });
    }
    ...
    public void onHfpStatus(final BluetoothDevice bluetoothDevice, final int i) {
        callbackEvent(new ICallbackHandler() { // from class: com.jieli.jl_bt_ota.tool.BtEventCallbackHelper$$ExternalSyntheticLambda10
            @Override // com.jieli.jl_bt_ota.tool.ICallbackHandler
            public final void onHandle(Object obj) {
    ...
    public void onMandatoryUpgrade(final BluetoothDevice bluetoothDevice) {
        callbackEvent(new ICallbackHandler() { // from class: com.jieli.jl_bt_ota.tool.BtEventCallbackHelper$$ExternalSyntheticLambda5
            @Override // com.jieli.jl_bt_ota.tool.ICallbackHandler
            public final void onHandle(Object obj) {
    ...
    public void onReceiveCommand(final BluetoothDevice bluetoothDevice, final CommandBase commandBase) {
        callbackEvent(new ICallbackHandler() { // from class: com.jieli.jl_bt_ota.tool.BtEventCallbackHelper$$ExternalSyntheticLambda6
            @Override // com.jieli.jl_bt_ota.tool.ICallbackHandler
            public final void onHandle(Object obj) {
