...
import com.tencent.cos.xml.model.p033ci.BaseDescribeQueuesResponse$$XmlAdapter;
...
public final class QCloudXml {
    ...
    public static <T> String toXml(T t) throws XmlPullParserException, IOException {
        ...
        toXml(xmlSerializerNewSerializer, t);
    ...
    private static <T> IXmlAdapter<T> createXmlAdapter(Class<?> cls) {
        ...
        try {
            BaseDescribeQueuesResponse$$XmlAdapter baseDescribeQueuesResponse$$XmlAdapter = (IXmlAdapter<T>) ((IXmlAdapter) Class.forName(name + "$$XmlAdapter").newInstance());
            map.put(cls, baseDescribeQueuesResponse$$XmlAdapter);
            return baseDescribeQueuesResponse$$XmlAdapter;
