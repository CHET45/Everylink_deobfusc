...
public class CallMetricsListener extends EventListener {
    ...
    public void dnsEnd(Call call, String str, List<InetAddress> list) {
        ...
        if (list != null) {
            ...
            while (it.hasNext()) {
                stringBuffer.append(it.next().getHostAddress()).append(PunctuationConst.COMMA);
            }
        }
        stringBuffer.append(PlaceholderUtil.DEFAULT_PLACEHOLDER_SUFFIX);
        COSLogger.iNetwork(QCloudHttpClient.HTTP_LOG_TAG, "dns: " + str + ":" + stringBuffer.toString());
