...
public class TransferService {
    ...
    public TransferService(CosXmlSimpleService cosXmlSimpleService, TransferConfig transferConfig, EncryptionMaterialsProvider encryptionMaterialsProvider) {
        ...
        this.kms = newTencentCloudKMSClient(cosXmlSimpleService.getCredentialProvider());
        this.cryptoModule = new CryptoModuleAE(this.kms, cosXmlSimpleService, cosXmlSimpleService.getCredentialProvider(), encryptionMaterialsProvider);
    }
