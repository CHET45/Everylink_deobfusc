...
public abstract class COSXMLTask {
    ...
    protected abstract void internalCancel(boolean z);

    protected abstract void internalCompleted();

    protected abstract void internalFailed();

    protected abstract void internalPause(boolean z);
    ...
    protected synchronized void updateState(TransferState transferState, Exception exc, CosXmlResult cosXmlResult, boolean z) {
        ...
        switch (C44302.$SwitchMap$com$tencent$cos$xml$transfer$TransferState[transferState.ordinal()]) {
            case 1:
            ...
            case 6:
                if (this.taskState != TransferState.CANCELED && this.taskState != TransferState.COMPLETED) {
                    ...
                    internalCancel(this.isCancelNow);
                }
                break;
            case 7:
    ...
    /* JADX INFO: renamed from: com.tencent.cos.xml.transfer.COSXMLTask$2 */
    ...
    protected Map<String, String> getCosXmlServiceConfigTrackParams() {
        ...
        if (cosXmlSimpleService != null && cosXmlSimpleService.getConfig() != null) {
            map.putAll(this.cosXmlService.getConfig().getTrackParams());
        }
        return map;
    }
}
