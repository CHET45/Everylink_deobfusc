...
public class DeleteDatasetBindingRequest extends AppIdRequest {
    ...
    public DeleteDatasetBindingRequest(String str) {
        super(str);
        addHeader("Accept", "application/json");
    }

    public void setDeleteDatasetBinding(DeleteDatasetBinding deleteDatasetBinding) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException {
        return RequestBodySerializer.bytes("application/json", QCloudJsonUtils.toJson(this.deleteDatasetBinding).getBytes("utf-8"));
    }
