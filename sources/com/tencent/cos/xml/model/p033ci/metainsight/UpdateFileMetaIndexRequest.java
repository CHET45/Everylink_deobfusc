...
public class UpdateFileMetaIndexRequest extends AppIdRequest {
    ...
    public UpdateFileMetaIndexRequest(String str) {
        super(str);
        addHeader("Accept", "application/json");
    }

    public void setUpdateFileMetaIndex(UpdateFileMetaIndex updateFileMetaIndex) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException {
        return RequestBodySerializer.bytes("application/json", QCloudJsonUtils.toJson(this.updateFileMetaIndex).getBytes("utf-8"));
    }
