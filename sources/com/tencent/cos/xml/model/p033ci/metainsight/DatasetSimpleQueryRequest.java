...
public class DatasetSimpleQueryRequest extends AppIdRequest {
    ...
    public DatasetSimpleQueryRequest(String str) {
        super(str);
        addHeader("Accept", "application/json");
    }

    public void setDatasetSimpleQuery(DatasetSimpleQuery datasetSimpleQuery) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException {
        return RequestBodySerializer.bytes("application/json", QCloudJsonUtils.toJson(this.datasetSimpleQuery).getBytes("utf-8"));
    }
