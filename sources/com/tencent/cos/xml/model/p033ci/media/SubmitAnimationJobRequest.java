...
public class SubmitAnimationJobRequest extends BucketRequest {
    ...
    public SubmitAnimationJobRequest(String str) {
        super(str);
    }

    public void setSubmitAnimationJob(SubmitAnimationJob submitAnimationJob) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.submitAnimationJob).getBytes("utf-8"));
    }
