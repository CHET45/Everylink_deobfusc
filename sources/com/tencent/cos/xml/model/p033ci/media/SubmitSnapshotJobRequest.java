...
public class SubmitSnapshotJobRequest extends BucketRequest {
    ...
    public SubmitSnapshotJobRequest(String str) {
        super(str);
    }

    public void setSubmitSnapshotJob(SubmitSnapshotJob submitSnapshotJob) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.submitSnapshotJob).getBytes("utf-8"));
    }
