...
public class SubmitExtractDigitalWatermarkJobRequest extends BucketRequest {
    ...
    public SubmitExtractDigitalWatermarkJobRequest(String str) {
        super(str);
    }

    public void setSubmitExtractDigitalWatermarkJob(SubmitExtractDigitalWatermarkJob submitExtractDigitalWatermarkJob) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.submitExtractDigitalWatermarkJob).getBytes("utf-8"));
    }
