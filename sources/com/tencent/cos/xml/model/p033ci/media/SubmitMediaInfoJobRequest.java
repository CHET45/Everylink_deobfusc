...
public class SubmitMediaInfoJobRequest extends BucketRequest {
    ...
    public SubmitMediaInfoJobRequest(String str) {
        super(str);
    }

    public void setSubmitMediaInfoJob(SubmitMediaInfoJob submitMediaInfoJob) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.submitMediaInfoJob).getBytes("utf-8"));
    }
