...
public class TemplateWatermarkRequest extends BucketRequest {
    ...
    public TemplateWatermarkRequest(String str) {
        super(str);
    }

    public void setTemplateWatermark(TemplateWatermark templateWatermark) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.templateWatermark).getBytes("utf-8"));
    }
