...
public class SubmitVideoMontageJobRequest extends BucketRequest {
    ...
    public SubmitVideoMontageJobRequest(String str) {
        super(str);
    }

    public void setSubmitVideoMontageJob(SubmitVideoMontageJob submitVideoMontageJob) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.submitVideoMontageJob).getBytes("utf-8"));
    }
