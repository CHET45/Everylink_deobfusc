...
public class TemplateTranscodeRequest extends BucketRequest {
    ...
    public TemplateTranscodeRequest(String str) {
        super(str);
    }

    public void setTemplateTranscode(TemplateTranscode templateTranscode) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.templateTranscode).getBytes("utf-8"));
    }
