...
public class TemplateAnimationRequest extends BucketRequest {
    ...
    public TemplateAnimationRequest(String str) {
        super(str);
    }
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.templateAnimation).getBytes("utf-8"));
    }
