...
public class TemplatePicProcessRequest extends BucketRequest {
    ...
    public TemplatePicProcessRequest(String str) {
        super(str);
    }

    public void setTemplatePicProcess(TemplatePicProcess templatePicProcess) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.templatePicProcess).getBytes("utf-8"));
    }
