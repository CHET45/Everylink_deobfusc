...
public class SubmitMediaSegmentJobRequest extends BucketRequest {
    ...
    public SubmitMediaSegmentJobRequest(String str) {
        super(str);
    }

    public void setSubmitMediaSegmentJob(SubmitMediaSegmentJob submitMediaSegmentJob) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.submitMediaSegmentJob).getBytes("utf-8"));
    }
