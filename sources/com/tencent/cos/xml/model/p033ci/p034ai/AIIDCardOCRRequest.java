...
public class AIIDCardOCRRequest extends BucketRequest {
    ...
    public AIIDCardOCRRequest(String str, String str2) {
        super(str);
        this.ciProcess = "IDCardOCR";
        this.objectKey = str2;
    }
    ...
    public Map<String, String> getQueryString() {
        ...
        this.queryParameters.put("CardSide", this.cardSide);
        this.queryParameters.put("Config", this.config);
