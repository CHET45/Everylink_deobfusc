...
public class ImageSearchBucketRequest extends BucketRequest {
    ...
    public ImageSearchBucketRequest(String str) {
        super(str);
    }

    public void setImageSearchBucket(ImageSearchBucket imageSearchBucket) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.imageSearchBucket).getBytes("utf-8"));
    }
