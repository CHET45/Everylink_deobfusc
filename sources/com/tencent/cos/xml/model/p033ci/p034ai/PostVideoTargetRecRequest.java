...
public class PostVideoTargetRecRequest extends BucketRequest {
    ...
    public PostVideoTargetRecRequest(String str) {
        super(str);
    }

    public void setPostVideoTargetRec(PostVideoTargetRec postVideoTargetRec) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.postVideoTargetRec).getBytes("utf-8"));
    }
