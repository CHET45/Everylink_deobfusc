...
public class UpdateVoiceSeparateTempleteRequest extends BucketRequest {
    ...
    public UpdateVoiceSeparateTempleteRequest(String str, String str2) {
        super(str);
        this.templateId = str2;
    }

    public void setUpdateVoiceSeparateTemplete(UpdateVoiceSeparateTemplete updateVoiceSeparateTemplete) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.updateVoiceSeparateTemplete).getBytes("utf-8"));
    }
