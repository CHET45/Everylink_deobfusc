...
public class PostNoiseReductionRequest extends BucketRequest {
    ...
    public PostNoiseReductionRequest(String str) {
        super(str);
    }

    public void setPostNoiseReduction(PostNoiseReduction postNoiseReduction) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.postNoiseReduction).getBytes("utf-8"));
    }
