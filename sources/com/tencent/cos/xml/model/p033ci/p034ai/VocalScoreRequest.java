...
public class VocalScoreRequest extends BucketRequest {
    private VocalScore vocalScore;

    public VocalScoreRequest(String str) {
        super(str);
    }
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.vocalScore).getBytes("utf-8"));
    }
