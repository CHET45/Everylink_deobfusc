...
public class CreateStrategyRequest extends BucketRequest {
    ...
    public CreateStrategyRequest(String str, String str2) {
        super(str);
        this.service = str2;
    }

    public void setStrategy(CreateStrategy createStrategy) {
    ...
    protected RequestBodySerializer xmlBuilder() throws XmlPullParserException, IOException, CosXmlClientException {
        return RequestBodySerializer.bytes("application/xml", QCloudXmlUtils.toXml(this.createStrategy).getBytes("utf-8"));
    }
