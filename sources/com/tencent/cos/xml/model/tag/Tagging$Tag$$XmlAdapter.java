...
public class Tagging$Tag$$XmlAdapter extends IXmlAdapter<Tagging.Tag> {
    ...
    public Tagging$Tag$$XmlAdapter() {
        ...
        map.put("Key", new ChildElementBinder<Tagging.Tag>() { // from class: com.tencent.cos.xml.model.tag.Tagging$Tag$$XmlAdapter.1
            ...
            public void fromXml(XmlPullParser xmlPullParser, Tagging.Tag tag, String str) throws XmlPullParserException, IOException {
                xmlPullParser.next();
    ...
    public Tagging.Tag fromXml(XmlPullParser xmlPullParser, String str) throws XmlPullParserException, IOException {
    ...
    @Override // com.tencent.qcloud.qcloudxml.core.IXmlAdapter
    public void toXml(XmlSerializer xmlSerializer, Tagging.Tag tag, String str) throws XmlPullParserException, IOException {
        if (tag == null) {
            return;
        }
        if (str == null) {
