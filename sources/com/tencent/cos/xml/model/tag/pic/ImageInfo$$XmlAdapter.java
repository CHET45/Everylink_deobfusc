...
public class ImageInfo$$XmlAdapter extends IXmlAdapter<ImageInfo> {
    ...
    public ImageInfo$$XmlAdapter() {
        ...
        this.childElementBinders.put("FrameCount", new ChildElementBinder<ImageInfo>() { // from class: com.tencent.cos.xml.model.tag.pic.ImageInfo$$XmlAdapter.7
            @Override // com.tencent.qcloud.qcloudxml.core.ChildElementBinder
            public void fromXml(XmlPullParser xmlPullParser, ImageInfo imageInfo, String str) throws XmlPullParserException, IOException {
                xmlPullParser.next();
                imageInfo.frameCount = Integer.parseInt(xmlPullParser.getText());
            }
        });
    }
