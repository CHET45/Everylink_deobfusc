...
public class QRCodeInfo$QRCodePoint$$XmlAdapter extends IXmlAdapter<QRCodeInfo.QRCodePoint> {
    ...
    public QRCodeInfo$QRCodePoint$$XmlAdapter() {
        HashMap<String, ChildElementBinder<QRCodeInfo.QRCodePoint>> map = new HashMap<>();
        this.childElementBinders = map;
        map.put("Point", new ChildElementBinder<QRCodeInfo.QRCodePoint>() { // from class: com.tencent.cos.xml.model.tag.pic.QRCodeInfo$QRCodePoint$$XmlAdapter.1
