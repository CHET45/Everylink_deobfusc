...
public class CallBackMqConfig$$XmlAdapter extends IXmlAdapter<CallBackMqConfig> {
    ...
    public CallBackMqConfig$$XmlAdapter() {
        ...
        map.put("MqRegion", new ChildElementBinder<CallBackMqConfig>() { // from class: com.tencent.cos.xml.model.tag.CallBackMqConfig$$XmlAdapter.1
        ...
        this.childElementBinders.put("MqMode", new ChildElementBinder<CallBackMqConfig>() { // from class: com.tencent.cos.xml.model.tag.CallBackMqConfig$$XmlAdapter.2
            @Override // com.tencent.qcloud.qcloudxml.core.ChildElementBinder
            public void fromXml(XmlPullParser xmlPullParser, CallBackMqConfig callBackMqConfig, String str) throws XmlPullParserException, IOException {
                xmlPullParser.next();
        ...
        this.childElementBinders.put("MqName", new ChildElementBinder<CallBackMqConfig>() { // from class: com.tencent.cos.xml.model.tag.CallBackMqConfig$$XmlAdapter.3
            @Override // com.tencent.qcloud.qcloudxml.core.ChildElementBinder
            public void fromXml(XmlPullParser xmlPullParser, CallBackMqConfig callBackMqConfig, String str) throws XmlPullParserException, IOException {
                xmlPullParser.next();
