...
public class WheelOptions<T> {
    ...
    public View getView() {
        return this.f2334view;
    }

    public void setView(View view2) {
        this.f2334view = view2;
    }

    public WheelOptions(View view2, boolean z) {
        this.isRestoreItem = z;
        this.f2334view = view2;
        this.wv_option1 = (WheelView) view2.findViewById(C1198R.id.options1);
        this.wv_option2 = (WheelView) view2.findViewById(C1198R.id.options2);
        this.wv_option3 = (WheelView) view2.findViewById(C1198R.id.options3);
    }
