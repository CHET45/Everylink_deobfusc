...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1485R.styleable.SegmentTabLayout);
        this.mIndicatorColor = typedArrayObtainStyledAttributes.getColor(C1485R.styleable.SegmentTabLayout_tl_indicator_color, Color.parseColor("#222831"));
        this.mIndicatorHeight = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SegmentTabLayout_tl_indicator_height, -1.0f);
        this.mIndicatorCornerRadius = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SegmentTabLayout_tl_indicator_corner_radius, -1.0f);
        this.mIndicatorMarginLeft = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SegmentTabLayout_tl_indicator_margin_left, dp2px(0.0f));
        this.mIndicatorMarginTop = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SegmentTabLayout_tl_indicator_margin_top, 0.0f);
        this.mIndicatorMarginRight = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SegmentTabLayout_tl_indicator_margin_right, dp2px(0.0f));
        this.mIndicatorMarginBottom = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SegmentTabLayout_tl_indicator_margin_bottom, 0.0f);
        this.mIndicatorAnimEnable = typedArrayObtainStyledAttributes.getBoolean(C1485R.styleable.SegmentTabLayout_tl_indicator_anim_enable, false);
        this.mIndicatorBounceEnable = typedArrayObtainStyledAttributes.getBoolean(C1485R.styleable.SegmentTabLayout_tl_indicator_bounce_enable, true);
        this.mIndicatorAnimDuration = typedArrayObtainStyledAttributes.getInt(C1485R.styleable.SegmentTabLayout_tl_indicator_anim_duration, -1);
        this.mDividerColor = typedArrayObtainStyledAttributes.getColor(C1485R.styleable.SegmentTabLayout_tl_divider_color, this.mIndicatorColor);
        this.mDividerWidth = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SegmentTabLayout_tl_divider_width, dp2px(1.0f));
        this.mDividerPadding = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SegmentTabLayout_tl_divider_padding, 0.0f);
        this.mTextsize = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SegmentTabLayout_tl_textsize, sp2px(13.0f));
        this.mTextSelectColor = typedArrayObtainStyledAttributes.getColor(C1485R.styleable.SegmentTabLayout_tl_textSelectColor, Color.parseColor("#ffffff"));
        this.mTextUnselectColor = typedArrayObtainStyledAttributes.getColor(C1485R.styleable.SegmentTabLayout_tl_textUnselectColor, this.mIndicatorColor);
        this.mTextBold = typedArrayObtainStyledAttributes.getInt(C1485R.styleable.SegmentTabLayout_tl_textBold, 0);
        this.mTextAllCaps = typedArrayObtainStyledAttributes.getBoolean(C1485R.styleable.SegmentTabLayout_tl_textAllCaps, false);
        this.mTabSpaceEqual = typedArrayObtainStyledAttributes.getBoolean(C1485R.styleable.SegmentTabLayout_tl_tab_space_equal, true);
        this.mTabWidth = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SegmentTabLayout_tl_tab_width, dp2px(-1.0f));
        this.mTabPadding = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SegmentTabLayout_tl_tab_padding, (this.mTabSpaceEqual || this.mTabWidth > 0.0f) ? dp2px(0.0f) : dp2px(10.0f));
        this.mBarColor = typedArrayObtainStyledAttributes.getColor(C1485R.styleable.SegmentTabLayout_tl_bar_color, 0);
        this.mBarStrokeColor = typedArrayObtainStyledAttributes.getColor(C1485R.styleable.SegmentTabLayout_tl_bar_stroke_color, this.mIndicatorColor);
        this.mBarStrokeWidth = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SegmentTabLayout_tl_bar_stroke_width, dp2px(1.0f));
        typedArrayObtainStyledAttributes.recycle();
    }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < this.mTabCount; i++) {
            View viewInflate = View.inflate(this.mContext, C1485R.layout.layout_tab_segment, null);
    ...
    private void addTab(int i, View view2) {
        ((TextView) view2.findViewById(C1485R.id.tv_tab_title)).setText(this.mTitles[i]);
        view2.setOnClickListener(new View.OnClickListener() { // from class: com.flyco.tablayout.SegmentTabLayout.1
