...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attributeSet) {
        float f;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1485R.styleable.SlidingTabLayout);
        this.mIndicatorStyle = typedArrayObtainStyledAttributes.getInt(C1485R.styleable.SlidingTabLayout_tl_indicator_style, 0);
        this.mIndicatorColor = typedArrayObtainStyledAttributes.getColor(C1485R.styleable.SlidingTabLayout_tl_indicator_color, Color.parseColor(this.mIndicatorStyle == 2 ? "#4B6A87" : "#ffffff"));
        int i = C1485R.styleable.SlidingTabLayout_tl_indicator_height;
        ...
        this.mIndicatorWidth = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SlidingTabLayout_tl_indicator_width, dp2px(this.mIndicatorStyle == 1 ? 10.0f : -1.0f));
        this.mIndicatorCornerRadius = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SlidingTabLayout_tl_indicator_corner_radius, dp2px(this.mIndicatorStyle == 2 ? -1.0f : 0.0f));
        this.mIndicatorMarginLeft = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SlidingTabLayout_tl_indicator_margin_left, dp2px(0.0f));
        this.mIndicatorMarginTop = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SlidingTabLayout_tl_indicator_margin_top, dp2px(this.mIndicatorStyle == 2 ? 7.0f : 0.0f));
        this.mIndicatorMarginRight = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SlidingTabLayout_tl_indicator_margin_right, dp2px(0.0f));
        this.mIndicatorMarginBottom = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SlidingTabLayout_tl_indicator_margin_bottom, dp2px(this.mIndicatorStyle != 2 ? 0.0f : 7.0f));
        this.mIndicatorGravity = typedArrayObtainStyledAttributes.getInt(C1485R.styleable.SlidingTabLayout_tl_indicator_gravity, 80);
        this.mIndicatorWidthEqualTitle = typedArrayObtainStyledAttributes.getBoolean(C1485R.styleable.SlidingTabLayout_tl_indicator_width_equal_title, false);
        this.mUnderlineColor = typedArrayObtainStyledAttributes.getColor(C1485R.styleable.SlidingTabLayout_tl_underline_color, Color.parseColor("#ffffff"));
        this.mUnderlineHeight = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SlidingTabLayout_tl_underline_height, dp2px(0.0f));
        this.mUnderlineGravity = typedArrayObtainStyledAttributes.getInt(C1485R.styleable.SlidingTabLayout_tl_underline_gravity, 80);
        this.mDividerColor = typedArrayObtainStyledAttributes.getColor(C1485R.styleable.SlidingTabLayout_tl_divider_color, Color.parseColor("#ffffff"));
        this.mDividerWidth = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SlidingTabLayout_tl_divider_width, dp2px(0.0f));
        this.mDividerPadding = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SlidingTabLayout_tl_divider_padding, dp2px(12.0f));
        this.mTextsize = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SlidingTabLayout_tl_textsize, sp2px(14.0f));
        this.mTextSelectColor = typedArrayObtainStyledAttributes.getColor(C1485R.styleable.SlidingTabLayout_tl_textSelectColor, Color.parseColor("#ffffff"));
        this.mTextUnselectColor = typedArrayObtainStyledAttributes.getColor(C1485R.styleable.SlidingTabLayout_tl_textUnselectColor, Color.parseColor("#AAffffff"));
        this.mTextBold = typedArrayObtainStyledAttributes.getInt(C1485R.styleable.SlidingTabLayout_tl_textBold, 0);
        this.mTextAllCaps = typedArrayObtainStyledAttributes.getBoolean(C1485R.styleable.SlidingTabLayout_tl_textAllCaps, false);
        this.mTabSpaceEqual = typedArrayObtainStyledAttributes.getBoolean(C1485R.styleable.SlidingTabLayout_tl_tab_space_equal, false);
        this.mTabWidth = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SlidingTabLayout_tl_tab_width, dp2px(-1.0f));
        this.mTabPadding = typedArrayObtainStyledAttributes.getDimension(C1485R.styleable.SlidingTabLayout_tl_tab_padding, (this.mTabSpaceEqual || this.mTabWidth > 0.0f) ? dp2px(0.0f) : dp2px(20.0f));
        typedArrayObtainStyledAttributes.recycle();
    }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < this.mTabCount; i++) {
            View viewInflate = View.inflate(this.mContext, C1485R.layout.layout_tab, null);
    ...
    private void addTab(int i, String str, View view2) {
        TextView textView = (TextView) view2.findViewById(C1485R.id.tv_tab_title);
        if (textView != null && str != null) {
            textView.setText(str);
        }
        view2.setOnClickListener(new View.OnClickListener() { // from class: com.flyco.tablayout.SlidingTabLayout.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view3) {
                int iIndexOfChild = SlidingTabLayout.this.mTabsContainer.indexOfChild(view3);
                if (iIndexOfChild != -1) {
    ...
    private void updateTabStyles() {
        ...
        while (i < this.mTabCount) {
            TextView textView = (TextView) this.mTabsContainer.getChildAt(i).findViewById(C1485R.id.tv_tab_title);
            if (textView != null) {
    ...
    private void calcIndicatorRect() {
        ...
        if (i < this.mTabCount - 1) {
            ...
            if (this.mIndicatorStyle == 0 && this.mIndicatorWidthEqualTitle) {
                TextView textView2 = (TextView) childAt2.findViewById(C1485R.id.tv_tab_title);
                this.mTextPaint.setTextSize(this.mTextsize);
