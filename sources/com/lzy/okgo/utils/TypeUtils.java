...
public class TypeUtils {
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.typeArguments) ^ this.rawType.hashCode()) ^ TypeUtils.hashCodeOrZero(this.ownerType);
        }
        ...
        public String toString() {
            ...
            sb.append("<").append(TypeUtils.typeToString(this.typeArguments[0]));
            for (int i = 1; i < this.typeArguments.length; i++) {
                sb.append(", ").append(TypeUtils.typeToString(this.typeArguments[i]));
            }
    ...
    private static final class WildcardTypeImpl implements WildcardType {
        ...
        public String toString() {
            return this.lowerBound != null ? "? super " + TypeUtils.typeToString(this.lowerBound) : this.upperBound == Object.class ? PunctuationConst.QUESTION_MARK : "? extends " + TypeUtils.typeToString(this.upperBound);
        }
    }
}
