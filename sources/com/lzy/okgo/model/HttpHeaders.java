...
public class HttpHeaders implements Serializable {
    ...
    public static String getAcceptLanguage() {
        if (TextUtils.isEmpty(acceptLanguage)) {
            ...
            if (!TextUtils.isEmpty(country)) {
                sb.append('-').append(country).append(CharConst.COMMA).append(language).append(";q=0.8");
            }
    ...
    public static String getUserAgent() {
        if (TextUtils.isEmpty(userAgent)) {
            String string = null;
            try {
                string = OkGo.getContext().getString(((Integer) Class.forName("com.android.internal.R$string").getDeclaredField("web_user_agent").get(null)).intValue());
