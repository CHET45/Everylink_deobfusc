...
public class BallGridBeatIndicator extends Indicator {
    ...
    public ArrayList<ValueAnimator> onCreateAnimators() {
        ...
        int[] iArr2 = {360, Constant.EVENT.BLE_GLASS_ASK_AI, 680, Constant.EVENT.BLE_GLASS_IS_SYNC, 710, -150, -120, 10, Constant.EVENT.BLE_SHOW_CONNECT_DIALOG};
        for (final int i = 0; i < 9; i++) {
            ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(255, GestureInfo.TALK_TO_TENCENT_XIAOWEI, 255);
