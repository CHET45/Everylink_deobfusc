...
public class AVLoadingIndicatorView extends View {
    ...
    public AVLoadingIndicatorView(Context context, AttributeSet attributeSet) {
        ...
        init(context, attributeSet, 0, C4490R.style.AVLoadingIndicatorView);
    }
    ...
    public AVLoadingIndicatorView(Context context, AttributeSet attributeSet, int i) {
        ...
        init(context, attributeSet, i, C4490R.style.AVLoadingIndicatorView);
    }
    ...
    private void init(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mMinHeight = 24;
        this.mMaxHeight = 48;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C4490R.styleable.AVLoadingIndicatorView, i, i2);
        this.mMinWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C4490R.styleable.AVLoadingIndicatorView_minWidth, this.mMinWidth);
        this.mMaxWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C4490R.styleable.AVLoadingIndicatorView_maxWidth, this.mMaxWidth);
        this.mMinHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C4490R.styleable.AVLoadingIndicatorView_minHeight, this.mMinHeight);
        this.mMaxHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C4490R.styleable.AVLoadingIndicatorView_maxHeight, this.mMaxHeight);
        String string = typedArrayObtainStyledAttributes.getString(C4490R.styleable.AVLoadingIndicatorView_indicatorName);
        this.mIndicatorColor = typedArrayObtainStyledAttributes.getColor(C4490R.styleable.AVLoadingIndicatorView_indicatorColor, -1);
        setIndicator(string);
