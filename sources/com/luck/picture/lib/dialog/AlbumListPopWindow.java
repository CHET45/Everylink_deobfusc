...
public class AlbumListPopWindow extends PopupWindow {
    ...
    public AlbumListPopWindow(Context context, SelectorConfig selectorConfig) {
        ...
        setContentView(LayoutInflater.from(context).inflate(C2114R.layout.ps_window_folder, (ViewGroup) null));
        setWidth(-1);
        setHeight(-2);
        setAnimationStyle(C2114R.style.PictureThemeWindowStyle);
        setFocusable(true);
    ...
    private void initViews() {
        ...
        this.mRecyclerView = (RecyclerView) getContentView().findViewById(C2114R.id.folder_list);
        this.windMask = getContentView().findViewById(C2114R.id.rootViewBg);
        ...
        getContentView().findViewById(C2114R.id.rootView).setOnClickListener(new View.OnClickListener() { // from class: com.luck.picture.lib.dialog.AlbumListPopWindow.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
