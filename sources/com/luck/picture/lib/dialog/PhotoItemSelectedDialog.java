...
public class PhotoItemSelectedDialog extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        return layoutInflater.inflate(C2114R.layout.ps_dialog_camera_selected, viewGroup);
    }

    @Override // androidx.fragment.app.Fragment
    public void onViewCreated(View view2, Bundle bundle) {
        super.onViewCreated(view2, bundle);
        TextView textView = (TextView) view2.findViewById(C2114R.id.ps_tv_photo);
        TextView textView2 = (TextView) view2.findViewById(C2114R.id.ps_tv_video);
        TextView textView3 = (TextView) view2.findViewById(C2114R.id.ps_tv_cancel);
    ...
    private void initDialogStyle() {
        ...
        window.setWindowAnimations(C2114R.style.PictureThemeDialogFragmentAnim);
    }
    ...
    public void onClick(View view2) {
        ...
        if (this.onItemClickListener != null) {
            if (id == C2114R.id.ps_tv_photo) {
                this.onItemClickListener.onItemClick(view2, 0);
                this.isCancel = false;
            } else if (id == C2114R.id.ps_tv_video) {
                this.onItemClickListener.onItemClick(view2, 1);
                this.isCancel = false;
            }
        }
