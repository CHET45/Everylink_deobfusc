...
public class PictureCommonDialog extends Dialog implements View.OnClickListener {
    ...
    public PictureCommonDialog(Context context, String str, String str2) {
        ...
        setContentView(C2114R.layout.ps_common_dialog);
        Button button = (Button) findViewById(C2114R.id.btn_cancel);
        Button button2 = (Button) findViewById(C2114R.id.btn_commit);
        TextView textView = (TextView) findViewById(C2114R.id.tvTitle);
    ...
    public void onClick(View view2) {
        int id = view2.getId();
        if (id == C2114R.id.btn_cancel) {
            dismiss();
            return;
        }
        if (id == C2114R.id.btn_commit) {
            dismiss();
