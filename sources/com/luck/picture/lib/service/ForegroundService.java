...
public class ForegroundService extends Service {
    ...
    private Notification createForegroundNotification() {
        ...
        return new NotificationCompat.Builder(this, CHANNEL_ID).setSmallIcon(C2114R.drawable.ps_ic_trans_1px).setContentTitle(getAppName()).setContentText(getString(SelectorProviders.getInstance().getSelectorConfig().chooseMode == SelectMimeType.ofAudio() ? C2114R.string.ps_use_sound : C2114R.string.ps_use_camera)).setOngoing(true).build();
    }
