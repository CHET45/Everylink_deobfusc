...
public class ImageViewHolder extends BaseRecyclerMediaHolder {
    ...
    public ImageViewHolder(View view2, SelectorConfig selectorConfig) {
        super(view2, selectorConfig);
        this.tvMediaTag = (TextView) view2.findViewById(C2114R.id.tv_media_tag);
        ImageView imageView = (ImageView) view2.findViewById(C2114R.id.ivEditor);
    ...
    public void bindData(LocalMedia localMedia, int i) {
        ...
        if (PictureMimeType.isHasGif(localMedia.getMimeType())) {
            this.tvMediaTag.setText(this.mContext.getString(C2114R.string.ps_gif_tag));
            return;
        }
        if (PictureMimeType.isHasWebp(localMedia.getMimeType())) {
            this.tvMediaTag.setText(this.mContext.getString(C2114R.string.ps_webp_tag));
        } else if (MediaUtils.isLongImage(localMedia.getWidth(), localMedia.getHeight())) {
            this.tvMediaTag.setText(this.mContext.getString(C2114R.string.ps_long_chart));
        } else {
