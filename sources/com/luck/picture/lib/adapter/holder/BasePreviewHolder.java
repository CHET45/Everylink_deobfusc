...
public abstract class BasePreviewHolder extends RecyclerView.ViewHolder {
    ...
    public BasePreviewHolder(View view2) {
        super(view2);
        this.selectorConfig = SelectorProviders.getInstance().getSelectorConfig();
        this.screenWidth = DensityUtil.getRealScreenWidth(view2.getContext());
        this.screenHeight = DensityUtil.getScreenHeight(view2.getContext());
        this.screenAppInHeight = DensityUtil.getRealScreenHeight(view2.getContext());
        this.coverImageView = (PhotoView) view2.findViewById(C2114R.id.preview_image);
        findViews(view2);
    }
