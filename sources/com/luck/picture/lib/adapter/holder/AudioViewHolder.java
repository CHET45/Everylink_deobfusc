...
public class AudioViewHolder extends BaseRecyclerMediaHolder {
    ...
    public AudioViewHolder(View view2, SelectorConfig selectorConfig) {
        super(view2, selectorConfig);
        TextView textView = (TextView) view2.findViewById(C2114R.id.tv_duration);
    ...
    protected void loadCover(String str) {
        this.ivPicture.setImageResource(C2114R.drawable.ps_audio_placeholder);
    }
}
