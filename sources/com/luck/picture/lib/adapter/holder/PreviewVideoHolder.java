...
public class PreviewVideoHolder extends BasePreviewHolder {
    ...
    public PreviewVideoHolder(View view2) {
        super(view2);
        this.isPlayed = false;
        ...
        this.progress = (ProgressBar) view2.findViewById(C2114R.id.progress);
        ...
        View viewOnCreateVideoPlayer = this.selectorConfig.videoPlayerEngine.onCreateVideoPlayer(view2.getContext());
