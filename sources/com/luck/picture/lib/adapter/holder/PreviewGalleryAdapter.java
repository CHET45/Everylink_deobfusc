...
public class PreviewGalleryAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(int i, LocalMedia localMedia, View view2);
    }

    public interface OnItemLongClickListener {
        void onItemLongClick(RecyclerView.ViewHolder viewHolder, int i, View view2);
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (layoutResource == 0) {
            layoutResource = C2114R.layout.ps_preview_gallery_item;
        }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        ...
        ColorFilter colorFilter = StyleUtils.getColorFilter(viewHolder.itemView.getContext(), localMedia.isGalleryEnabledMask() ? C2114R.color.ps_color_half_white : C2114R.color.ps_color_transparent);
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.luck.picture.lib.adapter.holder.PreviewGalleryAdapter.1
            ...
            public void onClick(View view2) {
                if (PreviewGalleryAdapter.this.listener != null) {
                    PreviewGalleryAdapter.this.listener.onItemClick(viewHolder.getAbsoluteAdapterPosition(), localMedia, view2);
                }
            }
        });
        viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.luck.picture.lib.adapter.holder.PreviewGalleryAdapter.2
            ...
            public boolean onLongClick(View view2) {
                ...
                PreviewGalleryAdapter.this.mItemLongClickListener.onItemLongClick(viewHolder, viewHolder.getAbsoluteAdapterPosition(), view2);
                return true;
            }
        });
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view2) {
            super(view2);
            this.ivImage = (ImageView) view2.findViewById(C2114R.id.ivImage);
            this.ivPlay = (ImageView) view2.findViewById(C2114R.id.ivPlay);
            this.ivEditor = (ImageView) view2.findViewById(C2114R.id.ivEditor);
            this.viewBorder = view2.findViewById(C2114R.id.viewBorder);
            ...
            if (StyleUtils.checkSizeValidity(adapterPreviewGalleryItemSize)) {
                view2.setLayoutParams(new RelativeLayout.LayoutParams(adapterPreviewGalleryItemSize, adapterPreviewGalleryItemSize));
            }
        }
    }
