...
public class PreviewAudioHolder extends BasePreviewHolder {
    ...
    public PreviewAudioHolder(View view2) {
        super(view2);
        ...
        this.ivPlayButton = (ImageView) view2.findViewById(C2114R.id.iv_play_video);
        this.tvAudioName = (TextView) view2.findViewById(C2114R.id.tv_audio_name);
        this.tvCurrentTime = (TextView) view2.findViewById(C2114R.id.tv_current_time);
        this.tvTotalDuration = (TextView) view2.findViewById(C2114R.id.tv_total_duration);
        this.seekBar = (SeekBar) view2.findViewById(C2114R.id.music_seek_bar);
        this.ivPlayBack = (ImageView) view2.findViewById(C2114R.id.iv_play_back);
        this.ivPlayFast = (ImageView) view2.findViewById(C2114R.id.iv_play_fast);
    }

    @Override // com.luck.picture.lib.adapter.holder.BasePreviewHolder
    protected void loadImage(LocalMedia localMedia, int i, int i2) {
        this.tvAudioName.setCompoundDrawablesRelativeWithIntrinsicBounds(0, C2114R.drawable.ps_ic_audio_play_cover, 0, 0);
    }
    ...
    public void playerDefaultUI(boolean z) {
        ...
        setBackFastUI(false);
        this.ivPlayButton.setImageResource(C2114R.drawable.ps_ic_audio_play);
    ...
    public void playerIngUI() {
        startUpdateProgress();
        setBackFastUI(true);
        this.ivPlayButton.setImageResource(C2114R.drawable.ps_ic_audio_stop);
    }
