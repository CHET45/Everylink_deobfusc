...
public class TitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    protected void init() {
        ...
        this.viewTopStatusBar = findViewById(C2114R.id.top_status_bar);
        this.titleBarLayout = (RelativeLayout) findViewById(C2114R.id.rl_title_bar);
        this.ivLeftBack = (ImageView) findViewById(C2114R.id.ps_iv_left_back);
        this.rlAlbumBg = (RelativeLayout) findViewById(C2114R.id.ps_rl_album_bg);
        this.ivDelete = (ImageView) findViewById(C2114R.id.ps_iv_delete);
        this.viewAlbumClickArea = findViewById(C2114R.id.ps_rl_album_click);
        this.tvTitle = (MarqueeTextView) findViewById(C2114R.id.ps_tv_title);
        this.ivArrow = (ImageView) findViewById(C2114R.id.ps_iv_arrow);
        this.tvCancel = (TextView) findViewById(C2114R.id.ps_tv_cancel);
        this.titleBarLine = findViewById(C2114R.id.title_bar_line);
        ...
        setBackgroundColor(ContextCompat.getColor(getContext(), C2114R.color.ps_color_grey));
        handleLayoutUI();
    ...
    protected void inflateLayout() {
        LayoutInflater.from(getContext()).inflate(C2114R.layout.ps_title_bar, this);
    }
    ...
    public void setTitleBarStyle() {
        ...
        if (this.config.isOnlySandboxDir) {
            this.ivArrow.setImageResource(C2114R.drawable.ps_ic_trans_1px);
        } else {
        ...
        if (StyleUtils.checkStyleValidity(previewDeleteBackgroundResource)) {
            ...
            this.ivDelete.setBackgroundResource(C2114R.drawable.ps_ic_delete);
        }
    }
    ...
    public void onClick(View view2) {
        ...
        int id = view2.getId();
        if (id == C2114R.id.ps_iv_left_back || id == C2114R.id.ps_tv_cancel) {
        ...
        if (id == C2114R.id.ps_rl_album_bg || id == C2114R.id.ps_rl_album_click) {
        ...
        if (id != C2114R.id.rl_title_bar || (onTitleBarListener = this.titleBarListener) == null) {
            return;
        }
