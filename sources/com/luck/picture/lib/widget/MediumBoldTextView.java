...
public class MediumBoldTextView extends AppCompatTextView {
    ...
    public MediumBoldTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C2114R.styleable.PictureMediumBoldTextView, i, 0);
        this.mStrokeWidth = typedArrayObtainStyledAttributes.getFloat(C2114R.styleable.PictureMediumBoldTextView_stroke_Width, this.mStrokeWidth);
