...
public class BottomNavBar extends RelativeLayout implements View.OnClickListener {
    ...
    protected void init() {
        ...
        this.tvPreview = (TextView) findViewById(C2114R.id.ps_tv_preview);
        this.tvImageEditor = (TextView) findViewById(C2114R.id.ps_tv_editor);
        this.originalCheckbox = (CheckBox) findViewById(C2114R.id.cb_original);
    ...
    protected void inflateLayout() {
        inflate(getContext(), C2114R.layout.ps_bottom_nav_bar, this);
    }
    ...
    public void setSelectedChange() {
        ...
        if (this.config.getSelectCount() > 0) {
            ...
            if (StyleUtils.checkStyleValidity(bottomPreviewSelectTextColor)) {
                ...
                this.tvPreview.setTextColor(ContextCompat.getColor(getContext(), C2114R.color.ps_color_fa632d));
            }
            ...
            this.tvPreview.setText(getContext().getString(C2114R.string.ps_preview_num, Integer.valueOf(this.config.getSelectCount())));
            return;
        }
        ...
        if (StyleUtils.checkStyleValidity(bottomPreviewNormalTextColor)) {
            ...
            this.tvPreview.setTextColor(ContextCompat.getColor(getContext(), C2114R.color.ps_color_9b));
        }
        String string2 = StyleUtils.checkStyleValidity(bottomBarStyle.getBottomPreviewNormalTextResId()) ? getContext().getString(bottomBarStyle.getBottomPreviewNormalTextResId()) : bottomBarStyle.getBottomPreviewNormalText();
        if (StyleUtils.checkTextValidity(string2)) {
            this.tvPreview.setText(string2);
        } else {
            this.tvPreview.setText(getContext().getString(C2114R.string.ps_preview));
        }
    }
    ...
    private void calculateFileTotalSize() {
        if (this.config.isOriginalControl) {
            ...
            if (size > 0) {
                this.originalCheckbox.setText(getContext().getString(C2114R.string.ps_original_image, PictureFileUtils.formatAccurateUnitFileSize(size)));
                return;
            } else {
                this.originalCheckbox.setText(getContext().getString(C2114R.string.ps_default_original_image));
                return;
            }
        }
        this.originalCheckbox.setText(getContext().getString(C2114R.string.ps_default_original_image));
    ...
    public void onClick(View view2) {
        if (this.bottomNavBarListener != null && view2.getId() == C2114R.id.ps_tv_preview) {
