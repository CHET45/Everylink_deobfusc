...
public class CompleteSelectView extends LinearLayout {
    ...
    private void init() {
        inflateLayout();
        setOrientation(0);
        this.tvSelectNum = (TextView) findViewById(C2114R.id.ps_tv_select_num);
        this.tvComplete = (TextView) findViewById(C2114R.id.ps_tv_complete);
        setGravity(16);
        this.numberChangeAnimation = AnimationUtils.loadAnimation(getContext(), C2114R.anim.ps_anim_modal_in);
        this.config = SelectorProviders.getInstance().getSelectorConfig();
    }

    protected void inflateLayout() {
        LayoutInflater.from(getContext()).inflate(C2114R.layout.ps_complete_selected_layout, this);
    }
    ...
    public void setSelectedChange(boolean z) {
        ...
        if (this.config.getSelectCount() > 0) {
            ...
            if (StyleUtils.checkStyleValidity(selectBackgroundResources)) {
                ...
                setBackgroundResource(C2114R.drawable.ps_ic_trans_1px);
            }
            ...
            if (StyleUtils.checkTextValidity(string)) {
                ...
                this.tvComplete.setText(getContext().getString(C2114R.string.ps_completed));
            }
            ...
            if (StyleUtils.checkStyleValidity(selectTextColor)) {
                ...
                this.tvComplete.setTextColor(ContextCompat.getColor(getContext(), C2114R.color.ps_color_fa632d));
            }
        ...
        if (z && selectMainStyle.isCompleteSelectRelativeTop()) {
            ...
            if (StyleUtils.checkStyleValidity(selectTextColor2)) {
                ...
                this.tvComplete.setTextColor(ContextCompat.getColor(getContext(), C2114R.color.ps_color_9b));
            }
        } else {
        ...
        if (StyleUtils.checkTextValidity(string2)) {
            ...
            this.tvComplete.setText(getContext().getString(C2114R.string.ps_please_select));
        }
        int selectNormalTextSize = selectMainStyle.getSelectNormalTextSize();
        if (StyleUtils.checkSizeValidity(selectNormalTextSize)) {
            this.tvComplete.setTextSize(selectNormalTextSize);
