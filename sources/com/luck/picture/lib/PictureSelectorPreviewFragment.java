...
public class PictureSelectorPreviewFragment extends PictureCommonFragment {
    ...
    private final ViewPager2.OnPageChangeCallback pageChangeCallback = new ViewPager2.OnPageChangeCallback() { // from class: com.luck.picture.lib.PictureSelectorPreviewFragment.22
        ...
        public void onPageSelected(int i) {
            ...
            if (PictureSelectorPreviewFragment.this.mData.size() > i) {
                ...
                if (i == PictureSelectorPreviewFragment.this.viewPageAdapter.getItemCount() - 11 || i == PictureSelectorPreviewFragment.this.viewPageAdapter.getItemCount() - 1) {
    ...
    public int getResourceId() {
        ...
        return layoutResource != 0 ? layoutResource : C2114R.layout.ps_fragment_preview;
    }
    ...
    public void onViewCreated(View view2, Bundle bundle) {
        ...
        this.titleBar = (PreviewTitleBar) view2.findViewById(C2114R.id.title_bar);
        this.tvSelected = (TextView) view2.findViewById(C2114R.id.ps_tv_selected);
        this.tvSelectedWord = (TextView) view2.findViewById(C2114R.id.ps_tv_selected_word);
        this.selectClickArea = view2.findViewById(C2114R.id.select_click_area);
        this.completeSelectView = (CompleteSelectView) view2.findViewById(C2114R.id.ps_complete_select);
        this.magicalView = (MagicalView) view2.findViewById(C2114R.id.magical);
        this.viewPager = new ViewPager2(getContext());
        this.bottomNarBar = (PreviewBottomNavBar) view2.findViewById(C2114R.id.bottom_nar_bar);
        ...
        if (this.isExternalPreview) {
            ...
            initBottomNavBar();
            initPreviewSelectGallery((ViewGroup) view2);
            initComplete();
        }
        iniMagicalView();
    }
    ...
    private void setMagicalViewBackgroundColor() {
        ...
        if (this.selectorConfig.chooseMode == SelectMimeType.ofAudio() || ((arrayList = this.mData) != null && arrayList.size() > 0 && PictureMimeType.isHasAudio(this.mData.get(0).getMimeType()))) {
            this.magicalView.setBackgroundColor(ContextCompat.getColor(getContext(), C2114R.color.ps_color_white));
        } else {
            this.magicalView.setBackgroundColor(ContextCompat.getColor(getContext(), C2114R.color.ps_color_black));
        }
    }
    ...
    public void changeViewParams(int[] iArr) {
        ...
        if (itemViewParams == null || iArr[0] == 0 || iArr[1] == 0) {
            ...
            this.magicalView.setViewParams(itemViewParams.left, itemViewParams.f2360top, itemViewParams.width, itemViewParams.height, iArr[0], iArr[1]);
    ...
    private void initComplete() {
        ...
        if (selectMainStyle.isCompleteSelectRelativeTop()) {
            if (this.completeSelectView.getLayoutParams() instanceof ConstraintLayout.LayoutParams) {
                ((ConstraintLayout.LayoutParams) this.completeSelectView.getLayoutParams()).topToTop = C2114R.id.title_bar;
                ((ConstraintLayout.LayoutParams) this.completeSelectView.getLayoutParams()).bottomToBottom = C2114R.id.title_bar;
        ...
        if (selectMainStyle.isPreviewSelectRelativeBottom()) {
            if (this.tvSelected.getLayoutParams() instanceof ConstraintLayout.LayoutParams) {
                ((ConstraintLayout.LayoutParams) this.tvSelected.getLayoutParams()).topToTop = C2114R.id.bottom_nar_bar;
                ((ConstraintLayout.LayoutParams) this.tvSelected.getLayoutParams()).bottomToBottom = C2114R.id.bottom_nar_bar;
                ((ConstraintLayout.LayoutParams) this.tvSelectedWord.getLayoutParams()).topToTop = C2114R.id.bottom_nar_bar;
                ((ConstraintLayout.LayoutParams) this.tvSelectedWord.getLayoutParams()).bottomToBottom = C2114R.id.bottom_nar_bar;
                ((ConstraintLayout.LayoutParams) this.selectClickArea.getLayoutParams()).topToTop = C2114R.id.bottom_nar_bar;
                ((ConstraintLayout.LayoutParams) this.selectClickArea.getLayoutParams()).bottomToBottom = C2114R.id.bottom_nar_bar;
            }
            ...
            */
            public void onClick(android.view.View r5) {
                ...
                L60:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.luck.picture.lib.PictureSelectorPreviewFragment.ViewOnClickListenerC21006.onClick(android.view.View):void");
            }
        });
    }
            ...
            public void onClick(View view2) {
                ...
                if (pictureSelectorPreviewFragment.confirmSelect(localMedia, pictureSelectorPreviewFragment.tvSelected.isSelected()) == 0) {
                    if (PictureSelectorPreviewFragment.this.selectorConfig.onSelectAnimListener != null) {
                        ...
                        PictureSelectorPreviewFragment.this.tvSelected.startAnimation(AnimationUtils.loadAnimation(PictureSelectorPreviewFragment.this.getContext(), C2114R.anim.ps_anim_modal_in));
                    }
                }
            }
        });
    ...
    protected void initPreviewSelectGallery(ViewGroup viewGroup) {
        ...
        if (selectMainStyle.isPreviewDisplaySelectGallery()) {
            ...
            if (StyleUtils.checkStyleValidity(selectMainStyle.getAdapterPreviewGalleryBackgroundResource())) {
                ...
                this.mGalleryRecycle.setBackgroundResource(C2114R.drawable.ps_preview_gallery_bg);
            }
            ...
            if (layoutParams instanceof ConstraintLayout.LayoutParams) {
                ...
                layoutParams2.bottomToTop = C2114R.id.bottom_nar_bar;
            ...
            if (this.selectorConfig.getSelectCount() > 0) {
                this.mGalleryRecycle.setLayoutAnimation(AnimationUtils.loadLayoutAnimation(getContext(), C2114R.anim.ps_anim_layout_fall_enter));
            }
            ...
            this.mGalleryAdapter.setItemClickListener(new PreviewGalleryAdapter.OnItemClickListener() { // from class: com.luck.picture.lib.PictureSelectorPreviewFragment.12
                ...
                public void onItemClick(final int i, LocalMedia localMedia, View view2) {
                    if (i == -1) {
                        return;
                    }
                    String string = TextUtils.isEmpty(PictureSelectorPreviewFragment.this.selectorConfig.defaultAlbumName) ? PictureSelectorPreviewFragment.this.getString(C2114R.string.ps_camera_roll) : PictureSelectorPreviewFragment.this.selectorConfig.defaultAlbumName;
            ...
            this.mGalleryAdapter.setItemLongClickListener(new PreviewGalleryAdapter.OnItemLongClickListener() { // from class: com.luck.picture.lib.PictureSelectorPreviewFragment.14
                ...
                public void onItemLongClick(RecyclerView.ViewHolder viewHolder, int i, View view2) {
    ...
    public void deletePreview() {
        ...
        this.titleBar.setTitle(getString(C2114R.string.ps_preview_image_num, Integer.valueOf(this.curPosition + 1), Integer.valueOf(this.mData.size())));
    ...
    public void onExternalLongPressDownload(final LocalMedia localMedia) {
        ...
        if (PictureMimeType.isHasAudio(localMedia.getMimeType()) || PictureMimeType.isUrlHasAudio(localMedia.getAvailablePath())) {
            string = getString(C2114R.string.ps_prompt_audio_content);
        } else if (PictureMimeType.isHasVideo(localMedia.getMimeType()) || PictureMimeType.isUrlHasVideo(localMedia.getAvailablePath())) {
            string = getString(C2114R.string.ps_prompt_video_content);
        } else {
            string = getString(C2114R.string.ps_prompt_image_content);
        }
        PictureCommonDialog.showDialog(getContext(), getString(C2114R.string.ps_prompt), string).setOnDialogEventListener(new PictureCommonDialog.OnDialogEventListener() { // from class: com.luck.picture.lib.PictureSelectorPreviewFragment.21
                    ...
                    public void onCall(String str) {
                        ...
                        if (TextUtils.isEmpty(str)) {
                            if (PictureMimeType.isHasAudio(localMedia.getMimeType())) {
                                string2 = PictureSelectorPreviewFragment.this.getString(C2114R.string.ps_save_audio_error);
                            } else if (PictureMimeType.isHasVideo(localMedia.getMimeType())) {
                                string2 = PictureSelectorPreviewFragment.this.getString(C2114R.string.ps_save_video_error);
                            } else {
                                string2 = PictureSelectorPreviewFragment.this.getString(C2114R.string.ps_save_image_error);
                            }
                        ...
                        ToastUtils.showToast(PictureSelectorPreviewFragment.this.getContext(), PictureSelectorPreviewFragment.this.getString(C2114R.string.ps_save_success) + "\n" + str);
                    }
                });
            }
        });
    ...
    public void setMagicalViewParams(int i, int i2, int i3) {
        ...
        if (itemViewParams == null || i == 0 || i2 == 0) {
            ...
            this.magicalView.setViewParams(itemViewParams.left, itemViewParams.f2360top, itemViewParams.width, itemViewParams.height, i, i2);
        }
    }

    private void getImageRealSizeFromMedia(final LocalMedia localMedia, boolean z, final OnCallbackListener<int[]> onCallbackListener) {
        int cropImageWidth;
        int cropImageHeight;
        boolean z2 = true;
        if (MediaUtils.isLongImage(localMedia.getWidth(), localMedia.getHeight())) {
            cropImageWidth = this.screenWidth;
            cropImageHeight = this.screenHeight;
        } else {
            int width = localMedia.getWidth();
            int height = localMedia.getHeight();
            if (z && ((width <= 0 || height <= 0 || width > height) && this.selectorConfig.isSyncWidthAndHeight)) {
