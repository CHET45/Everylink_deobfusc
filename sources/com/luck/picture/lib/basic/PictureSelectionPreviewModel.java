...
public final class PictureSelectionPreviewModel {
    ...
    public void startActivityPreview(int i, boolean z, ArrayList<LocalMedia> arrayList) {
        ...
        if (this.selectionConfig.isPreviewZoomEffect) {
            activity.overridePendingTransition(C2114R.anim.ps_anim_fade_in, C2114R.anim.ps_anim_fade_in);
        } else {
            activity.overridePendingTransition(this.selectionConfig.selectorStyle.getWindowAnimationStyle().activityEnterAnimation, C2114R.anim.ps_anim_fade_in);
        }
    }
}
