...
public class PictureSelectorTransparentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        initSelectorConfig();
        immersive();
        setContentView(C2114R.layout.ps_empty);
    ...
    private void immersive() {
        ...
        if (!StyleUtils.checkStyleValidity(statusBarColor)) {
            statusBarColor = ContextCompat.getColor(this, C2114R.color.ps_color_grey);
        }
        if (!StyleUtils.checkStyleValidity(navigationBarColor)) {
            navigationBarColor = ContextCompat.getColor(this, C2114R.color.ps_color_grey);
        }
    ...
    public void finish() {
        ...
        if (getIntent().getIntExtra(PictureConfig.EXTRA_MODE_TYPE_SOURCE, 0) == 2 && !this.selectorConfig.isPreviewZoomEffect) {
            ...
            overridePendingTransition(0, C2114R.anim.ps_anim_fade_out);
        }
    }
}
