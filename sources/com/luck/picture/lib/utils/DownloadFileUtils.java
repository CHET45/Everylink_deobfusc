            ...
            public String doInBackground() {
                ...
                try {
                    ...
                    if (PictureMimeType.isHasAudio(str2)) {
                        ...
                        contentValues.put("mime_type", (TextUtils.isEmpty(str2) || str2.startsWith("audio") || str2.startsWith(PictureMimeType.MIME_TYPE_PREFIX_IMAGE)) ? "video/mp4" : str2);
                        if (SdkVersionUtils.isQ()) {
                            contentValues.put("datetaken", string);
                        ...
                        contentValues.put("mime_type", (TextUtils.isEmpty(str2) || str2.startsWith("audio") || str2.startsWith(PictureMimeType.MIME_TYPE_PREFIX_VIDEO)) ? "image/jpeg" : str2);
                        if (SdkVersionUtils.isQ()) {
                            contentValues.put("datetaken", string);
