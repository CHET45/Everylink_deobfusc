...
public class TypeFactory implements Serializable {
    ...
    */
    ...
    public JavaType findFirstTypeParameter(JavaType javaType, Class<?> cls) {
        ...
        JavaType javaTypeFindSuperType = javaType.findSuperType(cls);
        return (javaTypeFindSuperType == null || (boundTypeOrNull = javaTypeFindSuperType.getBindings().getBoundTypeOrNull(0)) == null) ? _unknownType() : boundTypeOrNull;
    }
    ...
    protected JavaType _fromClass(ClassStack classStack, Class<?> cls, TypeBindings typeBindings) {
        ...
        if (cls.isArray()) {
            ...
            if (cls == Properties.class) {
                ...
                javaTypeRefine = MapType.construct(cls, typeBindings, javaType_resolveSuperClass, javaTypeArr, simpleType, simpleType);
            } else if (javaType_resolveSuperClass != null) {
                javaTypeRefine = javaType_resolveSuperClass.refine(cls, typeBindings, javaType_resolveSuperClass, javaTypeArr);
            }
            javaType_newSimpleType = (javaTypeRefine == null && (javaTypeRefine = _fromWellKnownClass(classStackChild, cls, typeBindings, javaType_resolveSuperClass, javaTypeArr)) == null && (javaTypeRefine = _fromWellKnownInterface(classStackChild, cls, typeBindings, javaType_resolveSuperClass, javaTypeArr)) == null) ? _newSimpleType(cls, typeBindings, javaType_resolveSuperClass, javaTypeArr) : javaTypeRefine;
        }
        classStackChild.resolveSelfReferences(javaType_newSimpleType);
        if (objAsKey != null && !javaType_newSimpleType.hasHandlers()) {
