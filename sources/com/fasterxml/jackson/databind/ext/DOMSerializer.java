...
public class DOMSerializer extends StdSerializer<Node> {
    ...
    public void serialize(Node node, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        try {
            ...
            transformerNewTransformer.setOutputProperty("omit-xml-declaration", XmlConsts.XML_SA_YES);
            transformerNewTransformer.setOutputProperty("indent", XmlConsts.XML_SA_NO);
