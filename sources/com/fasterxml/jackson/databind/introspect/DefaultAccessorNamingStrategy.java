...
public class DefaultAccessorNamingStrategy extends AccessorNamingStrategy {
    ...
    public static class Provider extends AccessorNamingStrategy.Provider implements Serializable {
        ...
        public Provider() {
            this(MethodConst.SET_PREFIX, JsonPOJOBuilder.DEFAULT_WITH_PREFIX, MethodConst.GET_PREFIX, MethodConst.IS_PREFIX, (BaseNameValidator) null);
        }
    ...
    public static class RecordNaming extends DefaultAccessorNamingStrategy {
        ...
        public RecordNaming(MapperConfig<?> mapperConfig, AnnotatedClass annotatedClass) {
            Set<String> hashSet;
            super(mapperConfig, annotatedClass, null, MethodConst.GET_PREFIX, MethodConst.IS_PREFIX, null);
