...
public class AnnotationIntrospectorPair extends AnnotationIntrospector implements Serializable {
    ...
    public Object findEnumNamingStrategy(MapperConfig<?> mapperConfig, AnnotatedClass annotatedClass) {
        Object objFindEnumNamingStrategy = this._primary.findEnumNamingStrategy(mapperConfig, annotatedClass);
        return objFindEnumNamingStrategy == null ? this._secondary.findEnumNamingStrategy(mapperConfig, annotatedClass) : objFindEnumNamingStrategy;
    }
    ...
    public JsonTypeInfo.Value findPolymorphicTypeInfo(MapperConfig<?> mapperConfig, Annotated annotated) {
        JsonTypeInfo.Value valueFindPolymorphicTypeInfo = this._primary.findPolymorphicTypeInfo(mapperConfig, annotated);
        return valueFindPolymorphicTypeInfo == null ? this._secondary.findPolymorphicTypeInfo(mapperConfig, annotated) : valueFindPolymorphicTypeInfo;
    }
    ...
    public Enum<?> findDefaultEnumValue(AnnotatedClass annotatedClass, Enum<?>[] enumArr) {
        Enum<?> enumFindDefaultEnumValue = this._primary.findDefaultEnumValue(annotatedClass, enumArr);
        return enumFindDefaultEnumValue == null ? this._secondary.findDefaultEnumValue(annotatedClass, enumArr) : enumFindDefaultEnumValue;
    }
    ...
    public PotentialCreator findDefaultCreator(MapperConfig<?> mapperConfig, AnnotatedClass annotatedClass, List<PotentialCreator> list, List<PotentialCreator> list2) {
        PotentialCreator potentialCreatorFindDefaultCreator = this._primary.findDefaultCreator(mapperConfig, annotatedClass, list, list2);
        return potentialCreatorFindDefaultCreator == null ? this._secondary.findDefaultCreator(mapperConfig, annotatedClass, list, list2) : potentialCreatorFindDefaultCreator;
    }
