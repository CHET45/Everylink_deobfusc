...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    private JsonInclude.Value _refinePropertyInclusion(Annotated annotated, JsonInclude.Value value) {
        ...
        if (jsonSerialize != null) {
            int i = C14371.f481xfdbfedae[jsonSerialize.include().ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C14371 {
        ...
        static final /* synthetic */ int[] f481xfdbfedae;
        ...
        static {
            ...
            try {
                f481xfdbfedae[JsonSerialize.Inclusion.NON_NULL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f481xfdbfedae[JsonSerialize.Inclusion.NON_DEFAULT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f481xfdbfedae[JsonSerialize.Inclusion.NON_EMPTY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f481xfdbfedae[JsonSerialize.Inclusion.DEFAULT_INCLUSION.ordinal()] = 5;
    ...
    public JavaType refineSerializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        JsonSerialize jsonSerialize = (JsonSerialize) _findAnnotation(annotated, JsonSerialize.class);
        Class<?> cls_classIfExplicit = jsonSerialize == null ? null : _classIfExplicit(jsonSerialize.m521as());
    ...
    public JavaType refineDeserializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        TypeFactory typeFactory = mapperConfig.getTypeFactory();
        JsonDeserialize jsonDeserialize = (JsonDeserialize) _findAnnotation(annotated, JsonDeserialize.class);
        Class<?> cls_classIfExplicit = jsonDeserialize == null ? null : _classIfExplicit(jsonDeserialize.m520as());
    ...
    public JsonCreator.Mode findCreatorAnnotation(MapperConfig<?> mapperConfig, Annotated annotated) {
        ...
        return (this._cfgConstructorPropertiesImpliesCreator && mapperConfig.isEnabled(MapperFeature.INFER_CREATOR_FROM_CONSTRUCTOR_PROPERTIES) && (annotated instanceof AnnotatedConstructor) && (java7Support = _java7Helper) != null && (boolHasCreatorAnnotation = java7Support.hasCreatorAnnotation(annotated)) != null && boolHasCreatorAnnotation.booleanValue()) ? JsonCreator.Mode.PROPERTIES : mode;
    }
    ...
    protected TypeResolverBuilder<?> _findTypeResolver(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        if (jsonTypeResolver != null) {
            ...
            if (valueFindPolymorphicTypeInfo.getIdType() == JsonTypeInfo.EnumC1422Id.NONE) {
        ...
        if (valueFindPolymorphicTypeInfo.getInclusionType() == JsonTypeInfo.EnumC1421As.EXTERNAL_PROPERTY && (annotated instanceof AnnotatedClass)) {
            valueFindPolymorphicTypeInfo = valueFindPolymorphicTypeInfo.withInclusionType(JsonTypeInfo.EnumC1421As.PROPERTY);
        }
