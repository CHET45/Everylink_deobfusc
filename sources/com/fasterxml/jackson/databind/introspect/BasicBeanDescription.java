...
public class BasicBeanDescription extends BeanDescription {
    ...
    public List<AnnotatedAndMetadata<AnnotatedConstructor, JsonCreator.Mode>> getConstructorsWithMode() {
        ...
        for (AnnotatedConstructor annotatedConstructor : constructors) {
            ...
            if (modeFindCreatorAnnotation != JsonCreator.Mode.DISABLED) {
                arrayList.add(AnnotatedAndMetadata.m523of(annotatedConstructor, modeFindCreatorAnnotation));
            }
        }
        return arrayList;
    }
    ...
    public PotentialCreators getPotentialCreators() {
        ...
        return pOJOPropertiesCollector.getPotentialCreators();
    }
    ...
    public JsonFormat.Value findExpectedFormat() {
        ...
        return pOJOPropertiesCollector.getFormatOverrides();
    }
    ...
    protected AnnotatedAndMetadata<AnnotatedMethod, JsonCreator.Mode> findFactoryMethodMetadata(AnnotatedMethod annotatedMethod) {
        ...
        if (modeFindCreatorAnnotation != null) {
            ...
            return AnnotatedAndMetadata.m523of(annotatedMethod, modeFindCreatorAnnotation);
        }
        String name = annotatedMethod.getName();
        if ("valueOf".equals(name) && annotatedMethod.getParameterCount() == 1) {
            return AnnotatedAndMetadata.m523of(annotatedMethod, modeFindCreatorAnnotation);
