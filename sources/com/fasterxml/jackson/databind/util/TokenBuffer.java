...
import com.fasterxml.jackson.core.p008io.JsonEOFException;
...
public class TokenBuffer extends JsonGenerator {
    ...
    public void serialize(JsonGenerator jsonGenerator) throws IOException {
        ...
        while (true) {
            ...
            switch (C14731.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonTokenType.ordinal()]) {
                case 1:
    ...
    public void writeString(Reader reader, int i) throws IOException {
        ...
        while (i2 > 0) {
            int i3 = reader.read(cArr, 0, Math.min(i2, 1000));
            if (i3 <= 0) {
                break;
            }
            sb.append(cArr, 0, i3);
    ...
    public void writeNumber(String str, boolean z) throws IOException {
        _appendValue(z ? JsonToken.VALUE_NUMBER_INT : JsonToken.VALUE_NUMBER_FLOAT, str);
    }
    ...
    public void copyCurrentEvent(JsonParser jsonParser) throws IOException {
        ...
        switch (C14731.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonParser.currentToken().ordinal()]) {
            case 1:
                writeStartObject();
                return;
            case 2:
            ...
            case 7:
                int i = C14731.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
                if (i == 1) {
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        ...
        int i = C14731.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonTokenCurrentToken.ordinal()];
        if (i == 1) {
            if (this._mayHaveNativeIds) {
                _checkNativeIds(jsonParser);
            }
    ...
    protected void _copyBufferContents(JsonParser jsonParser) throws IOException {
        ...
        while (true) {
            ...
            int i2 = C14731.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonTokenNextToken.ordinal()];
            if (i2 == 1) {
                if (this._mayHaveNativeIds) {
                    _checkNativeIds(jsonParser);
                }
    ...
    protected static final class Parser extends ParserMinimalBase {
        ...
        public JsonLocation currentLocation() {
            ...
            return jsonLocation == null ? JsonLocation.f451NA : jsonLocation;
        }
        ...
        public String getText() {
            ...
            int i = C14731.$SwitchMap$com$fasterxml$jackson$core$JsonToken[this._currToken.ordinal()];
            if (i == 7 || i == 8) {
        ...
        private Number getNumberValue(boolean z) throws IOException {
            ...
            if (obj_currentObject instanceof String) {
                ...
                if (z) {
                    ...
                    throw new IllegalStateException("Internal error: failed to parse number '" + str + PunctuationConst.SINGLE_QUOTES);
                }
