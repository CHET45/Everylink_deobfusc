    ...
    public static Date parse(String str, ParsePosition parsePosition) throws ParseException {
        ...
        try {
            ...
            if (zCheckOffset) {
                ...
                if (checkOffset(str, i11, CharConst.COLON)) {
                    i11 = i7 + 6;
                }
                int i13 = i11 + 2;
                int i14 = parseInt(str, i11, i13);
                if (checkOffset(str, i13, CharConst.COLON)) {
                    i13 = i11 + 3;
                }
                if (str.length() <= i13 || (cCharAt = str.charAt(i13)) == 'Z' || cCharAt == '+' || cCharAt == '-') {
                    ...
                    if (checkOffset(str, i15, CharConst.DOT)) {
                        int i16 = i13 + 3;
            ...
            if (cCharAt2 == 'Z') {
                ...
                if (cCharAt2 != '+' && cCharAt2 != '-') {
                    throw new IndexOutOfBoundsException("Invalid time zone indicator '" + cCharAt2 + PunctuationConst.SINGLE_QUOTES);
                }
            ...
            String str3 = str == null ? null : PunctuationConst.DOUBLE_QUOTES + str + '\"';
