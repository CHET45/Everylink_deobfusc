...
public class TypeKey {
    ...
    public final String toString() {
        if (this._class != null) {
            return "{class: " + this._class.getName() + ", typed? " + this._isTyped + PlaceholderUtil.DEFAULT_PLACEHOLDER_SUFFIX;
        }
        return "{type: " + this._type + ", typed? " + this._isTyped + PlaceholderUtil.DEFAULT_PLACEHOLDER_SUFFIX;
    }
