...
public class BeanPropertyWriter extends PropertyWriter implements Serializable {
    ...
    public String toString() {
        ...
        if (this._accessorMethod != null) {
            sb.append("via method ").append(this._accessorMethod.getDeclaringClass().getName()).append(PunctuationConst.SHAPE).append(this._accessorMethod.getName());
        } else if (this._field != null) {
            sb.append("field \"").append(this._field.getDeclaringClass().getName()).append(PunctuationConst.SHAPE).append(this._field.getName());
        } else {
            sb.append("virtual");
        }
        if (this._serializer == null) {
