...
public final class WritableObjectId {
    ...
    public boolean writeAsId(JsonGenerator jsonGenerator, SerializerProvider serializerProvider, ObjectIdWriter objectIdWriter) throws IOException {
        ...
        if (jsonGenerator.canWriteObjectId()) {
            jsonGenerator.writeObjectRef(String.valueOf(this.f484id));
            return true;
        }
        objectIdWriter.serializer.serialize(this.f484id, jsonGenerator, serializerProvider);
        return true;
    }

    public Object generateId(Object obj) {
        if (this.f484id == null) {
            this.f484id = this.generator.generateId(obj);
        }
        return this.f484id;
    }
