...
public abstract class BeanSerializerBase extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable {
    ...
    */
        ...
        if (valueFindFormatOverrides == null || !valueFindFormatOverrides.hasShape()) {
            ...
            if (shape != JsonFormat.Shape.ANY && shape != this._serializationShape) {
                if (this._beanType.isEnumType()) {
                    int i2 = C14641.$SwitchMap$com$fasterxml$jackson$annotation$JsonFormat$Shape[shape.ordinal()];
                    if (i2 == 1 || i2 == 2 || i2 == 3) {
    ...
    public JsonNode getSchema(SerializerProvider serializerProvider, Type type) throws JsonMappingException {
        ...
        if (jsonSerializableSchema != null && (strM525id = jsonSerializableSchema.m525id()) != null && !strM525id.isEmpty()) {
            objectNodeCreateSchemaNode.put("id", strM525id);
        }
        ...
        while (true) {
            ...
            if (i < beanPropertyWriterArr.length) {
                ...
                objectNodeCreateSchemaNode.set(Constants.QueryConstants.PROPERTIES, objectNode);
