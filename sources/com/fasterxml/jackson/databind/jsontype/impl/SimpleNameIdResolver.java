...
public class SimpleNameIdResolver extends TypeIdResolverBase implements Serializable {
    ...
    protected SimpleNameIdResolver(MapperConfig<?> mapperConfig, JavaType javaType, ConcurrentHashMap<String, String> concurrentHashMap, HashMap<String, JavaType> map) {
    ...
    public JsonTypeInfo.EnumC1422Id getMechanism() {
        return JsonTypeInfo.EnumC1422Id.SIMPLE_NAME;
    }
