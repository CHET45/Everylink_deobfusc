...
public abstract class JsonNode extends JsonSerializable.Base implements TreeNode, Iterable<JsonNode> {
    ...
    public final boolean isValueNode() {
        int i = C14251.$SwitchMap$com$fasterxml$jackson$databind$node$JsonNodeType[getNodeType().ordinal()];
    ...
    public final JsonNode mo509at(JsonPointer jsonPointer) {
        ...
        return jsonNode_at.mo509at(jsonPointer.tail());
    }

    @Override // com.fasterxml.jackson.core.TreeNode
    /* JADX INFO: renamed from: at */
    public final JsonNode mo510at(String str) {
        return mo509at(JsonPointer.compile(str));
    }
