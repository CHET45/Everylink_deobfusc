...
public abstract class DelegatingDeserializer extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer {
    ...
    public JsonDeserializer<Object> unwrappingDeserializer(NameTransformer nameTransformer) {
        JsonDeserializer<?> jsonDeserializerUnwrappingDeserializer = this._delegatee.unwrappingDeserializer(nameTransformer);
        return jsonDeserializerUnwrappingDeserializer == this._delegatee ? this : newDelegatingInstance(jsonDeserializerUnwrappingDeserializer);
    }
