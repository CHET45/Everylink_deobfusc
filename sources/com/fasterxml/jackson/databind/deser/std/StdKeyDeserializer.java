        ...
        private EnumResolver _getToStringResolver(DeserializationContext deserializationContext) {
            ...
            if (enumResolver == null) {
                synchronized (this) {
                    ...
                    if (enumResolver == null) {
                        EnumResolver enumResolverConstructUsingToString = EnumResolver.constructUsingToString(deserializationContext.getConfig(), this._byNameResolver.getEnumClass());
        ...
        private EnumResolver _getIndexResolver(DeserializationContext deserializationContext) {
            ...
            if (enumResolver == null) {
                synchronized (this) {
                    ...
                    if (enumResolver == null) {
                        EnumResolver enumResolverConstructUsingIndex = EnumResolver.constructUsingIndex(deserializationContext.getConfig(), this._byNameResolver.getEnumClass());
