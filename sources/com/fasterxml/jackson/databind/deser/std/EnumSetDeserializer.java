...
public class EnumSetDeserializer extends StdDeserializer<EnumSet<?>> implements ContextualDeserializer {
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext deserializationContext, BeanProperty beanProperty) throws JsonMappingException {
        ...
        return withResolved(jsonDeserializerHandleSecondaryContextualization, typeDeserializerForProperty, findContentNullProvider(deserializationContext, beanProperty, jsonDeserializerHandleSecondaryContextualization), boolFindFormatFeature);
    }
        ...
        while (true) {
            try {
                ...
                if (jsonTokenNextToken == JsonToken.VALUE_NULL) {
                    ...
                    enumDeserialize = (Enum) this._enumDeserializer.deserializeWithType(jsonParser, deserializationContext, typeDeserializer);
                }
