...
public class BeanDeserializerFactory extends BasicDeserializerFactory implements Serializable {
    ...
    protected JsonDeserializer<Object> buildBuilderBasedDeserializer(DeserializationContext deserializationContext, JavaType javaType, BeanDescription beanDescription) throws DatabindException {
        try {
            ValueInstantiator valueInstantiatorFindValueInstantiator = findValueInstantiator(deserializationContext, beanDescription);
            DeserializationConfig config = deserializationContext.getConfig();
            BeanDeserializerBuilder beanDeserializerBuilderConstructBeanDeserializerBuilder = constructBeanDeserializerBuilder(deserializationContext, beanDescription);
    ...
    protected void addObjectIdReader(DeserializationContext deserializationContext, BeanDescription beanDescription, BeanDeserializerBuilder beanDeserializerBuilder) throws JsonMappingException {
        ...
        beanDeserializerBuilder.setObjectIdReader(ObjectIdReader.construct(javaType, objectIdInfo.getPropertyName(), objectIdGeneratorObjectIdGeneratorInstance, jsonDeserializerFindRootValueDeserializer, settableBeanPropertyFindProperty, objectIdResolverObjectIdResolverInstance));
    }
    ...
    */
    ...
    protected void addBackReferenceProperties(DeserializationContext deserializationContext, BeanDescription beanDescription, BeanDeserializerBuilder beanDeserializerBuilder) throws DatabindException {
    ...
    @Deprecated
    protected void addReferenceProperties(DeserializationContext deserializationContext, BeanDescription beanDescription, BeanDeserializerBuilder beanDeserializerBuilder) throws DatabindException {
        addBackReferenceProperties(deserializationContext, beanDescription, beanDeserializerBuilder);
    }

    protected void addInjectables(DeserializationContext deserializationContext, BeanDescription beanDescription, BeanDeserializerBuilder beanDeserializerBuilder) throws DatabindException {
    ...
    protected SettableAnyProperty constructAnySetter(DeserializationContext deserializationContext, BeanDescription beanDescription, AnnotatedMember annotatedMember) throws JsonMappingException {
        ...
        if (annotatedMember instanceof AnnotatedMethod) {
            ...
            std2 = new BeanProperty.Std(PropertyName.construct(annotatedMember.getName()), javaTypeResolveMemberAndTypeAnnotations, null, annotatedMember, PropertyMetadata.STD_OPTIONAL);
        } else {
            if (z) {
                ...
                if (type2.isMapLikeType()) {
                    ...
                    keyType = javaTypeResolveMemberAndTypeAnnotations4.getKeyType();
                    contentType = javaTypeResolveMemberAndTypeAnnotations4.getContentType();
                    std = new BeanProperty.Std(PropertyName.construct(annotatedMember.getName()), javaTypeResolveMemberAndTypeAnnotations4, null, annotatedMember, PropertyMetadata.STD_OPTIONAL);
                } else {
                    if (type2.hasRawClass(JsonNode.class) || type2.hasRawClass(ObjectNode.class)) {
                        ...
                        return SettableAnyProperty.constructForJsonNodeParameter(deserializationContext, new BeanProperty.Std(PropertyName.construct(annotatedMember.getName()), javaTypeResolveMemberAndTypeAnnotations5, null, annotatedMember, PropertyMetadata.STD_OPTIONAL), annotatedMember, javaTypeConstructType2, deserializationContext.findRootValueDeserializer(javaTypeConstructType2), index);
                    }
                    return (SettableAnyProperty) deserializationContext.reportBadDefinition(beanDescription.getType(), String.format("Unsupported type for any-setter: %s -- only support `Map`s, `JsonNode` and `ObjectNode` ", ClassUtil.getTypeDescription(type2)));
                }
            } else {
        ...
        if (objFindKeyDeserializerFromAnnotation == null) {
            objFindKeyDeserializerFromAnnotation = deserializationContext.findKeyDeserializer(keyType, std2);
        } else if (objFindKeyDeserializerFromAnnotation instanceof ContextualKeyDeserializer) {
            objFindKeyDeserializerFromAnnotation = ((ContextualKeyDeserializer) objFindKeyDeserializerFromAnnotation).createContextual(deserializationContext, std2);
        }
        ...
        if (jsonDeserializerFindContentDeserializerFromAnnotation != null) {
            jsonDeserializerFindContentDeserializerFromAnnotation = deserializationContext.handlePrimaryContextualization(jsonDeserializerFindContentDeserializerFromAnnotation, std2, javaTypeResolveMemberAndTypeAnnotations);
        }
        ...
        if (z) {
            return SettableAnyProperty.constructForMapField(deserializationContext, std2, annotatedMember, javaTypeResolveMemberAndTypeAnnotations, r5, jsonDeserializer, typeDeserializer);
        }
        if (z2) {
            return SettableAnyProperty.constructForMapParameter(deserializationContext, std2, annotatedMember, javaTypeResolveMemberAndTypeAnnotations, r5, jsonDeserializer, typeDeserializer, index);
        }
        return SettableAnyProperty.constructForMethod(deserializationContext, std2, annotatedMember, javaTypeResolveMemberAndTypeAnnotations, r5, jsonDeserializer, typeDeserializer);
    }
