...
public class CreatorProperty extends SettableBeanProperty {
    ...
    private void _reportMissingSetter(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        AnnotatedParameter annotatedParameter = this._annotated;
        String str = String.format("No fallback setter/field defined for creator property %s (of %s)", ClassUtil.name(getName()), annotatedParameter == null ? "UNKNOWN TYPE" : ClassUtil.getClassDescription(annotatedParameter.getOwner().getDeclaringClass()));
