...
public class UTF8DataInputJsonParser extends JsonParserBase {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:35:0x009e, code lost:
        ...
        throw reportInvalidBase64Char(r12, r6, 3, "expected padding character '" + r12.getPaddingChar() + com.github.houbb.heaven.constant.PunctuationConst.SINGLE_QUOTES);
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
            ...
            if (unsignedByte != 34 && iArr[unsignedByte] != 0) {
                ...
                if (unsignedByte > 127) {
                    ...
                    if (unsignedByte < 2048) {
                        i3 = (i3 << 8) | (unsignedByte >> 6) | Opcodes.CHECKCAST;
                        i++;
                    } else {
    ...
    /* JADX WARN: Removed duplicated region for block: B:39:0x00c0 A[PHI: r5 r14
  0x00c0: PHI (r5v19 int) = (r5v18 int), (r5v31 int) binds: [B:28:0x0082, B:37:0x00b4] A[DONT_GENERATE, DONT_INLINE]
  0x00c0: PHI (r14v6 int) = (r14v5 int), (r14v15 int) binds: [B:28:0x0082, B:37:0x00b4] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private final int _decodeUtf8_2(int i) throws IOException {
        int unsignedByte = this._inputData.readUnsignedByte();
        if ((unsignedByte & Opcodes.CHECKCAST) != 128) {
    ...
    private final int _decodeUtf8_3(int i) throws IOException {
        ...
        int unsignedByte2 = this._inputData.readUnsignedByte();
        if ((unsignedByte2 & Opcodes.CHECKCAST) != 128) {
    ...
    private final int _decodeUtf8_4(int i) throws IOException {
        ...
        int unsignedByte3 = this._inputData.readUnsignedByte();
        if ((unsignedByte3 & Opcodes.CHECKCAST) != 128) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:35:0x009a, code lost:
        ...
        throw reportInvalidBase64Char(r9, r2, 3, "expected padding character '" + r9.getPaddingChar() + com.github.houbb.heaven.constant.PunctuationConst.SINGLE_QUOTES);
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected final byte[] _decodeBase64(com.fasterxml.jackson.core.Base64Variant r9) throws java.io.IOException {
        /*
