...
import com.fasterxml.jackson.core.p008io.NumberOutput;
...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
            ...
            do {
                ...
                if (c <= 127) {
                    ...
                    if (c2 < 2048) {
                        ...
                        int i8 = i7 + 1;
                        this._outputTail = i8;
                        bArr[i7] = (byte) ((c2 >> 6) | Opcodes.CHECKCAST);
                        this._outputTail = i7 + 2;
                        bArr[i8] = (byte) ((c2 & '?') | 128);
                        i = i6;
                    } else {
    ...
    private final void _writeStringSegment2(char[] cArr, int i, int i2) throws IOException {
        ...
        while (i < i2) {
            ...
            if (c <= 127) {
                ...
                bArr[i_writeGenericEscape] = (byte) ((c >> 6) | Opcodes.CHECKCAST);
                i_writeGenericEscape += 2;
                bArr[i6] = (byte) ((c & '?') | 128);
                i = i3;
    ...
    private final void _writeStringSegment2(String str, int i, int i2) throws IOException {
        ...
        while (i < i2) {
            ...
            if (cCharAt <= 127) {
                ...
                int i6 = i_writeGenericEscape + 1;
                bArr[i_writeGenericEscape] = (byte) ((cCharAt >> 6) | Opcodes.CHECKCAST);
                i_writeGenericEscape += 2;
    ...
    private final void _writeStringSegmentASCII2(char[] cArr, int i, int i2) throws IOException {
        ...
        while (i < i2) {
            ...
            if (c <= 127) {
                ...
                bArr[i_outputMultiByteChar] = (byte) ((c >> 6) | Opcodes.CHECKCAST);
                i_outputMultiByteChar += 2;
                bArr[i7] = (byte) ((c & '?') | 128);
            } else {
    ...
    private final void _writeStringSegmentASCII2(String str, int i, int i2) throws IOException {
        ...
        while (i < i2) {
            ...
            if (cCharAt <= 127) {
                ...
                int i7 = i_outputMultiByteChar + 1;
                bArr[i_outputMultiByteChar] = (byte) ((cCharAt >> 6) | Opcodes.CHECKCAST);
                i_outputMultiByteChar += 2;
            ...
            if (c <= 127) {
                ...
                if (i5 == 0) {
                    ...
                    if (i5 > 0) {
                        ...
                        i_writeGenericEscape = _writeCustomEscape(bArr, i_writeGenericEscape, escapeSequence, i2 - i4);
                    } else {
                        i_writeGenericEscape = _writeGenericEscape(c, i_writeGenericEscape);
                    }
                    i = i4;
                ...
                if (c > i3) {
                    ...
                    if (escapeSequence2 != null) {
                        i_writeGenericEscape = _writeCustomEscape(bArr, i_writeGenericEscape, escapeSequence2, i2 - i4);
                    } else if (c <= 2047) {
                        int i7 = i_writeGenericEscape + 1;
                        bArr[i_writeGenericEscape] = (byte) ((c >> 6) | Opcodes.CHECKCAST);
                        i_writeGenericEscape += 2;
                        bArr[i7] = (byte) ((c & '?') | 128);
                    } else if (_isStartOfSurrogatePair(c) && JsonGenerator.Feature.COMBINE_UNICODE_SURROGATES_IN_UTF8.enabledIn(this._features) && i4 < i2) {
                        i += 2;
                        i_writeGenericEscape = _outputSurrogatePair(c, cArr[i4], i_writeGenericEscape);
                    } else {
                        i_outputMultiByteChar = _outputMultiByteChar(c, i_writeGenericEscape);
                        i_writeGenericEscape = i_outputMultiByteChar;
                    }
            ...
            if (cCharAt <= 127) {
                ...
                if (cCharAt > i3) {
                    ...
                    if (escapeSequence2 != null) {
                        ...
                        i_writeGenericEscape += 2;
                        bArr[i7] = (byte) ((cCharAt & '?') | 128);
                    } else if (_isStartOfSurrogatePair(cCharAt) && JsonGenerator.Feature.COMBINE_UNICODE_SURROGATES_IN_UTF8.enabledIn(this._features) && i4 < i2) {
                        i += 2;
                        i_writeGenericEscape = _outputSurrogatePair(cCharAt, str.charAt(i4), i_writeGenericEscape);
                    } else {
                        i_outputMultiByteChar = _outputMultiByteChar(cCharAt, i_writeGenericEscape);
                        i_writeGenericEscape = i_outputMultiByteChar;
                    }
    ...
    protected final void _writeBinary(Base64Variant base64Variant, byte[] bArr, int i, int i2) throws IOException {
        ...
        loop0: while (true) {
            ...
            while (i <= i3) {
                ...
                i += 3;
                iEncodeBase64Chunk = base64Variant.encodeBase64Chunk(i7 | (bArr[i6] & UByte.MAX_VALUE), this._outputBuffer, this._outputTail);
    ...
    protected final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException {
        ...
        while (true) {
            ...
            int i7 = i6 + 2;
            int i8 = ((bArr[i6 + 1] & UByte.MAX_VALUE) | (bArr[i6] << 8)) << 8;
            i6 += 3;
            i5 -= 3;
            int iEncodeBase64Chunk = base64Variant.encodeBase64Chunk(i8 | (bArr[i7] & UByte.MAX_VALUE), this._outputBuffer, this._outputTail);
            this._outputTail = iEncodeBase64Chunk;
            maxLineLength--;
            if (maxLineLength <= 0) {
                byte[] bArr2 = this._outputBuffer;
    ...
    protected final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr) throws IOException {
        ...
        while (true) {
            ...
            int i6 = i4 + 2;
            int i7 = ((bArr[i4 + 1] & UByte.MAX_VALUE) | (bArr[i4] << 8)) << 8;
            i4 += 3;
            i5 += 3;
            int iEncodeBase64Chunk = base64Variant.encodeBase64Chunk(i7 | (bArr[i6] & UByte.MAX_VALUE), this._outputBuffer, this._outputTail);
            this._outputTail = iEncodeBase64Chunk;
            maxLineLength--;
            if (maxLineLength <= 0) {
                byte[] bArr2 = this._outputBuffer;
    ...
    protected final void _outputSurrogates(int i, int i2) throws IOException {
        ...
        int i4 = i3 + 1;
        this._outputTail = i4;
        bArr[i3] = (byte) ((i_decodeSurrogate >> 18) | Command.CMD_CUSTOM);
        int i5 = i3 + 2;
        this._outputTail = i5;
    ...
    private int _outputSurrogatePair(char c, char c2, int i) {
        ...
        byte[] bArr = this._outputBuffer;
        bArr[i] = (byte) (((i2 >> 18) & 7) + Command.CMD_CUSTOM);
