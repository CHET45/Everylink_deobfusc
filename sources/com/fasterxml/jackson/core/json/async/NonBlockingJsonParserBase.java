...
public abstract class NonBlockingJsonParserBase extends JsonParserBase {
    ...
    protected final String _getText2(JsonToken jsonToken) throws IOException {
        int iM508id;
        if (jsonToken == null || (iM508id = jsonToken.m508id()) == -1) {
            return null;
        }
        if (iM508id == 5) {
  ...
  0x00c5: PHI (r5v19 int) = (r5v18 int), (r5v31 int) binds: [B:28:0x0087, B:37:0x00b9] A[DONT_GENERATE, DONT_INLINE]
  0x00c5: PHI (r14v6 int) = (r14v5 int), (r14v15 int) binds: [B:28:0x0087, B:37:0x00b9] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    protected final java.lang.String _addName(int[] r18, int r19, int r20) throws com.fasterxml.jackson.core.JsonParseException, com.fasterxml.jackson.core.exc.StreamConstraintsException {
        /*
