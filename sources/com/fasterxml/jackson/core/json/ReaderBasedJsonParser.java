...
public class ReaderBasedJsonParser extends JsonParserBase {
    ...
    */
                ...
                if (iDecodeBase64Char3 < 0) {
                    ...
                    if (iDecodeBase64Char3 == -2) {
                        ...
                        if (!base64Variant.usesPaddingChar(c4) && _decodeBase64Escape(base64Variant, c4, 3) != -2) {
                            throw reportInvalidBase64Char(base64Variant, c4, 3, "expected padding character '" + base64Variant.getPaddingChar() + PunctuationConst.SINGLE_QUOTES);
                        }
                        byteArrayBuilder_getByteArrayBuilder.append(i3 >> 4);
                    }
                }
    ...
    protected JsonLocation _currentLocationMinusOne() {
        int i = this._inputPtr - 1;
        return new JsonLocation(_contentReference(), -1L, ((long) i) + this._currInputProcessed, this._currInputRow, (i - this._currInputRowStart) + 1);
    }
