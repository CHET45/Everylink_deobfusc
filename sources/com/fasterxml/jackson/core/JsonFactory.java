...
import com.fasterxml.jackson.core.p008io.InputDecorator;
import com.fasterxml.jackson.core.p008io.OutputDecorator;
import com.fasterxml.jackson.core.p008io.SerializedString;
import com.fasterxml.jackson.core.p008io.UTF8Writer;
...
public class JsonFactory extends TokenStreamFactory implements Serializable {
    ...
    public JsonFactory setStreamReadConstraints(StreamReadConstraints streamReadConstraints) {
        ...
        StreamReadConstraints streamReadConstraints2 = (StreamReadConstraints) Objects.requireNonNull(streamReadConstraints);
        this._streamReadConstraints = streamReadConstraints2;
        if (streamReadConstraints2.getMaxNameLength() != maxNameLength) {
            this._rootCharSymbols = CharsToNameCanonicalizer.createRoot(this);
        }
        return this;
    }
    ...
    protected IOContext _createContext(ContentReference contentReference, boolean z) {
        ...
        IOContext iOContext = new IOContext(this._streamReadConstraints, this._streamWriteConstraints, this._errorReportConfiguration, bufferRecycler == null ? _getBufferRecycler() : bufferRecycler, contentReference, z);
        if (z2) {
