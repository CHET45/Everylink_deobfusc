...
public abstract class JsonParser implements Closeable, Versioned {
    ...
    public void setSchema(FormatSchema formatSchema) {
        throw new UnsupportedOperationException("Parser of type " + getClass().getName() + " does not support schema of type '" + formatSchema.getSchemaType() + PunctuationConst.SINGLE_QUOTES);
    }
    ...
    protected JsonParseException _constructReadException(String str, JsonLocation jsonLocation) {
