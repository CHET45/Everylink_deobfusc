...
public enum JsonToken {
    ...
    START_OBJECT("{", 1),
    END_OBJECT(PlaceholderUtil.DEFAULT_PLACEHOLDER_SUFFIX, 2),
    START_ARRAY("[", 3),
    END_ARRAY("]", 4),
    FIELD_NAME(null, 5),
    ...
    public static String valueDescFor(JsonToken jsonToken) {
        ...
        switch (C14241.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonToken.ordinal()]) {
            case 1:
            case 2:
            case 3:
                return "Object value";
    ...
    /* JADX INFO: renamed from: com.fasterxml.jackson.core.JsonToken$1 */
