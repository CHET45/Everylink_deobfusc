...
import com.fasterxml.jackson.core.p008io.schubfach.DoubleToDecimal;
import com.fasterxml.jackson.core.p008io.schubfach.FloatToDecimal;
...
public final class NumberOutput {
    ...
    public static int outputInt(int i, char[] cArr, int i2) {
        ...
        int i6 = i - (iDivBy10002 * 1000);
        int iDivBy10003 = divBy1000(iDivBy10002);
        return _full3(i6, cArr, _full3(iDivBy10002 - (iDivBy10003 * 1000), cArr, _leading3(iDivBy10003, cArr, i2)));
    }
    ...
    private static int _outputUptoBillion(int i, char[] cArr, int i2) {
        ...
        cArr[i_leading3 + 1] = (char) ((i5 >> 8) & WorkQueueKt.MASK);
        cArr[i_leading3 + 2] = (char) (i5 & WorkQueueKt.MASK);
        int i6 = iArr[i3];
        cArr[i_leading3 + 3] = (char) (i6 >> 16);
        int i7 = i_leading3 + 5;
        cArr[i_leading3 + 4] = (char) ((i6 >> 8) & WorkQueueKt.MASK);
        int i8 = i_leading3 + 6;
        cArr[i7] = (char) (i6 & WorkQueueKt.MASK);
        return i8;
    }
    ...
    private static int _outputFullBillion(int i, char[] cArr, int i2) {
        ...
        cArr[i2] = (char) (i4 >> 16);
        cArr[i2 + 1] = (char) ((i4 >> 8) & WorkQueueKt.MASK);
        cArr[i2 + 2] = (char) (i4 & WorkQueueKt.MASK);
        int i5 = iArr[iDivBy1000 - (iDivBy10002 * 1000)];
        cArr[i2 + 3] = (char) (i5 >> 16);
        cArr[i2 + 4] = (char) ((i5 >> 8) & WorkQueueKt.MASK);
        cArr[i2 + 5] = (char) (i5 & WorkQueueKt.MASK);
        int i6 = iArr[i3];
        cArr[i2 + 6] = (char) (i6 >> 16);
        int i7 = i2 + 8;
        cArr[i2 + 7] = (char) ((i6 >> 8) & WorkQueueKt.MASK);
        int i8 = i2 + 9;
        cArr[i7] = (char) (i6 & WorkQueueKt.MASK);
        return i8;
    }
    ...
    private static int _outputUptoMillion(char[] cArr, int i, int i2, int i3) {
        ...
        cArr[i + 1] = (char) (i5 >> 16);
        int i6 = i + 3;
        cArr[i + 2] = (char) ((i5 >> 8) & WorkQueueKt.MASK);
        int i7 = i + 4;
        cArr[i6] = (char) (i5 & WorkQueueKt.MASK);
        return i7;
    }
    ...
    private static int _full3(int i, char[] cArr, int i2) {
        ...
        cArr[i2] = (char) (i3 >> 16);
        int i4 = i2 + 2;
        cArr[i2 + 1] = (char) ((i3 >> 8) & WorkQueueKt.MASK);
        int i5 = i2 + 3;
        cArr[i4] = (char) (i3 & WorkQueueKt.MASK);
        return i5;
    }
