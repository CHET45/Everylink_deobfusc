...
public final class UTF8Writer extends Writer {
    ...
    */
    public void write(char[] r9, int r10, int r11) throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.p008io.UTF8Writer.write(char[], int, int):void");
    }
    ...
    public void write(int i) throws IOException {
        ...
        if (i < 2048) {
            ...
            bArr4[i5] = (byte) ((i >> 18) | Command.CMD_CUSTOM);
    ...
    */
    public void write(java.lang.String r9, int r10, int r11) throws java.io.IOException {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.p008io.UTF8Writer.write(java.lang.String, int, int):void");
    }
    ...
    protected static String illegalSurrogateDesc(int i) {
        ...
        if (i >= 55296) {
            return i <= 56319 ? "Unmatched first part of surrogate pair (0x" + Integer.toHexString(i) + ")" : "Unmatched second part of surrogate pair (0x" + Integer.toHexString(i) + ")";
        }
