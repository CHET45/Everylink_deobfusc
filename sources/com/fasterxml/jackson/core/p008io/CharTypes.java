...
public final class CharTypes {
    ...
    protected static final byte[] f454HB;
    protected static final byte[] HBlower;

    /* JADX INFO: renamed from: HC */
    protected static final char[] f455HC;
    ...
    static {
        ...
        f454HB = new byte[length];
        HBlower = new byte[length];
        for (int i = 0; i < length; i++) {
            f454HB[i] = (byte) f455HC[i];
        ...
        for (int i3 = 128; i3 < 256; i3++) {
            iArr2[i3] = (i3 & 224) == 192 ? 2 : (i3 & Command.CMD_CUSTOM) == 224 ? 3 : (i3 & 248) == 240 ? 4 : -1;
        }
    ...
    public static int[] get7BitOutputEscapes(int i, boolean z) {
        if (i != 34) {
            return AltEscapes.instance.escapesFor(i, z);
        }
        if (z) {
    ...
    public static char[] copyHexChars(boolean z) {
        return (char[]) (z ? f455HC.clone() : HClower.clone());
    }
    ...
    public static byte[] copyHexBytes(boolean z) {
        return (byte[]) (z ? f454HB.clone() : HBlower.clone());
    }
