...
public final class JSR310Module extends SimpleModule {
    ...
    public void setupModule(Module.SetupContext setupContext) {
        ...
        setupContext.addValueInstantiators(new ValueInstantiators.Base() { // from class: com.fasterxml.jackson.datatype.jsr310.JSR310Module.1
            ...
            public ValueInstantiator findValueInstantiator(DeserializationConfig deserializationConfig, BeanDescription beanDescription, ValueInstantiator valueInstantiator) {
                AnnotatedClass annotatedClassConstruct;
                ...
                if (ZoneId.class.isAssignableFrom(rawClass) && (valueInstantiator instanceof StdValueInstantiator)) {
                    ...
                    if (rawClass == ZoneId.class) {
                        annotatedClassConstruct = beanDescription.getClassInfo();
                    } else {
                        annotatedClassConstruct = AnnotatedClass.construct(deserializationConfig.constructType(ZoneId.class), deserializationConfig);
                    }
                    if (!stdValueInstantiator.canCreateFromString() && (annotatedMethod_findFactory = JSR310Module.this._findFactory(annotatedClassConstruct, "of", String.class)) != null) {
