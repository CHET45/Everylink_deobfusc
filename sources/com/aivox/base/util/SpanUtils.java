...
public class SpanUtils {
    ...
    private static final String LINE_SEPARATOR = System.getProperty(SystemConst.LINE_SEPARATOR);
    private int alignImage;
    private int alignLine;
    private Layout.Alignment alignment;
    private int backgroundColor;
    private int batterBackgroundColor;
    ...
    private int underlineColor = Color.parseColor("#FCBF49");
    ...
    private void setDefault() {
        ...
        this.batterBackgroundColor = COLOR_DEFAULT;
        this.lineHeight = -1;
    ...
    public SpanUtils setBatterBackgroundColor(int i) {
        this.batterBackgroundColor = i;
        return this;
    }
    ...
    public SpanUtils setUnderline(int i) {
        this.isUnderline = true;
    ...
    private void updateCharCharSequence() {
        ...
        if (this.batterBackgroundColor != COLOR_DEFAULT) {
            this.mBuilder.setSpan(new BetterHighlightSpan(this, this.batterBackgroundColor), length, length2, this.flag);
        }
        if (this.first != -1) {
        ...
        if (this.isUnderline) {
            this.mBuilder.setSpan(new UnderLineColorSpan(this.underlineColor), length, length2, 18);
        }
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(Bitmap bitmap, int i) {
            super(i);
            BitmapDrawable bitmapDrawable = new BitmapDrawable(BaseAppUtils.getContext().getResources(), bitmap);
        ...
        @Override // com.aivox.base.util.SpanUtils.CustomDynamicDrawableSpan
        public Drawable getDrawable() {
            ...
            if (this.mContentUri != null) {
                try {
                    inputStreamOpenInputStream = BaseAppUtils.getContext().getContentResolver().openInputStream(this.mContentUri);
                    bitmapDrawable = new BitmapDrawable(BaseAppUtils.getContext().getResources(), BitmapFactory.decodeStream(inputStreamOpenInputStream));
                } catch (Exception e) {
                    e = e;
                }
                try {
            ...
            try {
                drawable = ContextCompat.getDrawable(BaseAppUtils.getContext(), this.mResourceId);
                try {
    ...
    class ShadowSpan extends CharacterStyle implements UpdateAppearance {
        ...
        private float f195dx;

        /* JADX INFO: renamed from: dy */
        private float f196dy;
        ...
        @Override // android.text.style.CharacterStyle
        public void updateDrawState(TextPaint textPaint) {
            textPaint.setShadowLayer(this.radius, this.f195dx, this.f196dy, this.shadowColor);
        }
    }

    private class UnderLineColorSpan extends UnderlineSpan {
        private int color;
    ...
    public class BetterHighlightSpan extends ReplacementSpan {
        ...
        public BetterHighlightSpan(SpanUtils spanUtils, int i) {
            this(spanUtils, i, 0);
        }

        public BetterHighlightSpan(SpanUtils spanUtils, int i, int i2) {
            this(i, i2, 10);
        }
        ...
        public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
            int color = paint.getColor();
            RectF rectF = new RectF(f, i3 + this.topSpacingExtra, paint.measureText(charSequence, i, i2) + f, i5 - this.lineSpacingExtra);
