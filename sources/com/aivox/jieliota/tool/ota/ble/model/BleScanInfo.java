...
public class BleScanInfo implements Parcelable {
    public static final Parcelable.Creator<BleScanInfo> CREATOR = new Parcelable.Creator<BleScanInfo>() { // from class: com.aivox.jieliota.tool.ota.ble.model.BleScanInfo.1
