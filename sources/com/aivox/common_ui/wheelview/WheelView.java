package com.aivox.common_ui.wheelview;
...
import com.aivox.common_ui.wheelview.WheelScroller;
import com.aivox.common_ui.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.visibleItems = 5;
        this.itemHeight = 0;
        this.wheelBackground = C1034R.drawable.wheel_bg;
        this.wheelForeground = C1034R.drawable.wheel_val;
        ...
        this.label = "";
        this.scrollingListener = new WheelScroller.ScrollingListener() { // from class: com.aivox.common_ui.wheelview.WheelView.1
            @Override // com.aivox.common_ui.wheelview.WheelScroller.ScrollingListener
        ...
        this.dataObserver = new DataSetObserver() { // from class: com.aivox.common_ui.wheelview.WheelView.2
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(C0874R.color.province_line_border));
