...
public class WheelScroller {
    ...
    private GestureDetector.SimpleOnGestureListener gestureListener = new GestureDetector.SimpleOnGestureListener() { // from class: com.aivox.common_ui.wheelview.WheelScroller.1
    ...
    private Handler animationHandler = new Handler() { // from class: com.aivox.common_ui.wheelview.WheelScroller.2
