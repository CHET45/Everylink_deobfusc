...
public class WheelRecycle {
    ...
    private List<View> addView(View view2, List<View> list) {
        if (list == null) {
            list = new LinkedList<>();
        }
        list.add(view2);
    ...
    private void recycleView(View view2, int i) {
        ...
        int i2 = i % itemsCount;
        this.items = addView(view2, this.items);
    }
