...
public class ExpandableTextView2 extends RelativeLayout implements View.OnClickListener {
    ...
    private void findViews() {
        ((LayoutInflater) getContext().getSystemService("layout_inflater")).inflate(C1034R.layout.item_expand_collapse2, this);
    ...
    public void onClick(View view2) {
        ...
        Log.i("tag", "mCollapsed:" + this.mCollapsed + ";height:" + getHeight() + ":mCollapsedHeight:" + this.mCollapsedHeight + ";collaps:" + this.mTvContent.getHeight() + ";mTextHeightWithMaxLines:" + this.mTextHeightWithMaxLines);
        if (this.mCollapsed) {
            new ValueAnimator();
            valueAnimatorOfInt = ValueAnimator.ofInt(getHeight() + this.mTvContent.getHeight(), this.mCollapsedHeight);
        } else {
            this.mCollapsedHeight = getHeight();
            new ValueAnimator();
            valueAnimatorOfInt = ValueAnimator.ofInt(getHeight() + this.mTvContent.getHeight(), getHeight() + this.mTextHeightWithMaxLines + this.mTvContent.getHeight());
        }
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.aivox.common_ui.expandabletextview.ExpandableTextView2.1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                int iIntValue = ((Integer) valueAnimator.getAnimatedValue()).intValue();
                ExpandableTextView2.this.mTvContent.setMaxHeight(iIntValue - ExpandableTextView2.this.mMarginBetweenTxtAndBottom);
                ExpandableTextView2.this.getLayoutParams().height = iIntValue;
                ExpandableTextView2.this.requestLayout();
            }
        });
        valueAnimatorOfInt.addListener(new Animator.AnimatorListener() { // from class: com.aivox.common_ui.expandabletextview.ExpandableTextView2.2
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if (ExpandableTextView2.this.mListener != null) {
                    ExpandableTextView2.this.mListener.onExpandStateChanged(ExpandableTextView2.this.mTvContent, !ExpandableTextView2.this.mCollapsed);
                }
            }
        });
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (lineCount > i3 && i3 != 0) {
            ...
            super.onMeasure(i, i2);
            if (this.mCollapsed) {
                this.mTvContent.post(new Runnable() { // from class: com.aivox.common_ui.expandabletextview.ExpandableTextView2.3
                    @Override // java.lang.Runnable
                    public void run() {
                        ExpandableTextView2 expandableTextView2 = ExpandableTextView2.this;
                        expandableTextView2.mMarginBetweenTxtAndBottom = expandableTextView2.getHeight() - ExpandableTextView2.this.mTvContent.getHeight();
                    }
                });
    ...
    private static int getRealTextViewHeight(TextView textView, int i) {
