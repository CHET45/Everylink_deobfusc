...
class PermissionDelegateImplV23 extends PermissionDelegateImplV21 {
    ...
    public boolean isGrantedPermission(Context context, String str) {
        if (Permission.getPermissionFromAndroidVersion(str) > AndroidVersion.getAndroidVersionCode()) {
            ...
            if (PermissionUtils.equalsPermission(str, "android.permission.BLUETOOTH_CONNECT") || PermissionUtils.equalsPermission(str, "android.permission.BLUETOOTH_ADVERTISE")) {
                return true;
            }
    ...
    public boolean isDoNotAskAgainPermission(Activity activity, String str) {
        if (Permission.getPermissionFromAndroidVersion(str) > AndroidVersion.getAndroidVersionCode()) {
            ...
            if (PermissionUtils.equalsPermission(str, Permission.NEARBY_WIFI_DEVICES)) {
                return (PermissionUtils.checkSelfPermission(activity, "android.permission.ACCESS_FINE_LOCATION") || PermissionUtils.shouldShowRequestPermissionRationale(activity, "android.permission.ACCESS_FINE_LOCATION")) ? false : true;
            }
            if (PermissionUtils.equalsPermission(str, Permission.BODY_SENSORS_BACKGROUND)) {
