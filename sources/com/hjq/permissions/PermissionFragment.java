...
public final class PermissionFragment extends Fragment implements Runnable {
    ...
    public void splitTwiceRequestPermission(Activity activity, ArrayList<String> arrayList, ArrayList<String> arrayList2, int i) {
        ...
        }, new C19772(activity, arrayList3, arrayList, i));
    }

    /* JADX INFO: renamed from: com.hjq.permissions.PermissionFragment$2 */
    class C19772 implements OnPermissionCallback {
        final /* synthetic */ Activity val$activity;
        final /* synthetic */ ArrayList val$allPermissions;
        final /* synthetic */ int val$requestCode;
        final /* synthetic */ ArrayList val$secondPermissions;

        C19772(Activity activity, ArrayList arrayList, ArrayList arrayList2, int i) {
            ...
            if (z && PermissionFragment.this.isAdded()) {
                ...
                PermissionUtils.postDelayed(new Runnable() { // from class: com.hjq.permissions.PermissionFragment$2$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m2665lambda$onGranted$0$comhjqpermissionsPermissionFragment$2(activity, arrayList, arrayList2, i);
                    }
                }, j);
            }
        }
        ...
        /* synthetic */ void m2665lambda$onGranted$0$comhjqpermissionsPermissionFragment$2(Activity activity, final ArrayList arrayList, final ArrayList arrayList2, final int i) {
