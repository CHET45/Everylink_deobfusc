...
final class PermissionChecker {
    ...
    static void checkLocationPermission(List<String> list) {
        if (PermissionUtils.containsPermission(list, Permission.ACCESS_BACKGROUND_LOCATION)) {
            if (PermissionUtils.containsPermission(list, Permission.ACCESS_COARSE_LOCATION) && !PermissionUtils.containsPermission(list, "android.permission.ACCESS_FINE_LOCATION")) {
            ...
            for (String str : list) {
                if (!PermissionUtils.equalsPermission(str, "android.permission.ACCESS_FINE_LOCATION") && !PermissionUtils.equalsPermission(str, Permission.ACCESS_COARSE_LOCATION) && !PermissionUtils.equalsPermission(str, Permission.ACCESS_BACKGROUND_LOCATION)) {
    ...
    static void checkNearbyDevicesPermission(List<String> list, AndroidManifestInfo androidManifestInfo) {
        if ((!PermissionUtils.containsPermission(list, "android.permission.BLUETOOTH_SCAN") && !PermissionUtils.containsPermission(list, Permission.NEARBY_WIFI_DEVICES)) || PermissionUtils.containsPermission(list, "android.permission.ACCESS_FINE_LOCATION") || androidManifestInfo == null) {
            return;
        }
        for (AndroidManifestInfo.PermissionInfo permissionInfo : androidManifestInfo.permissionInfoList) {
            if (PermissionUtils.equalsPermission(permissionInfo.name, "android.permission.BLUETOOTH_SCAN") || PermissionUtils.equalsPermission(permissionInfo.name, Permission.NEARBY_WIFI_DEVICES)) {
    ...
    static void checkReadMediaVisualUserSelectedPermission(List<String> list) {
        if (PermissionUtils.containsPermission(list, Permission.READ_MEDIA_VISUAL_USER_SELECTED) && !PermissionUtils.containsPermission(list, "android.permission.READ_MEDIA_IMAGES") && !PermissionUtils.containsPermission(list, "android.permission.READ_MEDIA_VIDEO")) {
        ...
        for (String str : list) {
            if (Permission.isMustRegisterInManifestFile(str)) {
                ...
                if (PermissionUtils.equalsPermission(str, Permission.BODY_SENSORS_BACKGROUND)) {
                    ...
                    } else if (PermissionUtils.equalsPermission(str, "android.permission.BLUETOOTH_SCAN")) {
                        checkManifestPermission(list2, "android.permission.BLUETOOTH_ADMIN", 30);
                        checkManifestPermission(list2, "android.permission.ACCESS_FINE_LOCATION", 30);
                    } else if (PermissionUtils.equalsPermission(str, "android.permission.BLUETOOTH_CONNECT")) {
                        checkManifestPermission(list2, "android.permission.BLUETOOTH", 30);
                    } else if (PermissionUtils.equalsPermission(str, "android.permission.BLUETOOTH_ADVERTISE")) {
                        checkManifestPermission(list2, "android.permission.BLUETOOTH_ADMIN", 30);
    ...
    static void optimizeDeprecatedPermission(List<String> list) {
        if (!AndroidVersion.isAndroid13()) {
            ...
            if (PermissionUtils.containsPermission(list, Permission.NEARBY_WIFI_DEVICES) && !PermissionUtils.containsPermission(list, "android.permission.ACCESS_FINE_LOCATION")) {
        ...
        if (!AndroidVersion.isAndroid12() && PermissionUtils.containsPermission(list, "android.permission.BLUETOOTH_SCAN") && !PermissionUtils.containsPermission(list, "android.permission.ACCESS_FINE_LOCATION")) {
            list.add("android.permission.ACCESS_FINE_LOCATION");
        }
