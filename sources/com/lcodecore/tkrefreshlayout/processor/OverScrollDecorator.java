...
public class OverScrollDecorator extends Decorator {
    ...
    public OverScrollDecorator(TwinklingRefreshLayout.CoContext coContext, IDecorator iDecorator) {
        ...
        this.mHandler = new Handler() { // from class: com.lcodecore.tkrefreshlayout.processor.OverScrollDecorator.1
            ...
            public void handleMessage(Message message) {
                int touchSlop = OverScrollDecorator.this.f816cp.getTouchSlop();
                int i = message.what;
                if (i == 0) {
                ...
                View targetView = OverScrollDecorator.this.f816cp.getTargetView();
                if (OverScrollDecorator.this.f816cp.allowOverScroll()) {
                    if (OverScrollDecorator.this.mVelocityY >= 3000.0f) {
                        if (ScrollingUtil.isViewToTop(targetView, touchSlop)) {
                            OverScrollDecorator.this.f816cp.getAnimProcessor().animOverScrollTop(OverScrollDecorator.this.mVelocityY, OverScrollDecorator.this.cur_delay_times);
                        ...
                        OverScrollDecorator.this.f816cp.getAnimProcessor().animOverScrollBottom(OverScrollDecorator.this.mVelocityY, OverScrollDecorator.this.cur_delay_times);
                        OverScrollDecorator.this.mVelocityY = 0.0f;
                        OverScrollDecorator.this.cur_delay_times = 60;
                    }
                }
    ...
    public void onFingerDown(MotionEvent motionEvent) {
        ...
        this.preventTopOverScroll = ScrollingUtil.isViewToTop(this.f816cp.getTargetView(), this.f816cp.getTouchSlop());
        this.preventBottomOverScroll = ScrollingUtil.isViewToBottom(this.f816cp.getTargetView(), this.f816cp.getTouchSlop());
    }
    ...
    public void onFingerFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
        ...
        if (this.f816cp.enableOverScroll()) {
            int y = (int) (motionEvent2.getY() - motionEvent.getY());
            if (y >= (-this.f816cp.getTouchSlop()) || !this.preventBottomOverScroll) {
                if (y <= this.f816cp.getTouchSlop() || !this.preventTopOverScroll) {
                    this.mVelocityY = f2;
