...
public class TwinklingRefreshLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
    ...
    private float f805vx;

    /* JADX INFO: renamed from: vy */
    private float f806vy;
    ...
    public TwinklingRefreshLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2015R.styleable.TwinklingRefreshLayout, i, 0);
        try {
            this.mMaxHeadHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2015R.styleable.TwinklingRefreshLayout_tr_max_head_height, DensityUtil.dp2px(context, 120.0f));
            this.mHeadHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2015R.styleable.TwinklingRefreshLayout_tr_head_height, DensityUtil.dp2px(context, 80.0f));
            this.mMaxBottomHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2015R.styleable.TwinklingRefreshLayout_tr_max_bottom_height, DensityUtil.dp2px(context, 120.0f));
            this.mBottomHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2015R.styleable.TwinklingRefreshLayout_tr_bottom_height, DensityUtil.dp2px(context, 60.0f));
            this.mOverScrollHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2015R.styleable.TwinklingRefreshLayout_tr_overscroll_height, (int) this.mHeadHeight);
            this.enableRefresh = typedArrayObtainStyledAttributes.getBoolean(C2015R.styleable.TwinklingRefreshLayout_tr_enable_refresh, true);
            this.enableLoadmore = typedArrayObtainStyledAttributes.getBoolean(C2015R.styleable.TwinklingRefreshLayout_tr_enable_loadmore, true);
            this.isPureScrollModeOn = typedArrayObtainStyledAttributes.getBoolean(C2015R.styleable.TwinklingRefreshLayout_tr_pureScrollMode_on, false);
            this.isOverScrollTopShow = typedArrayObtainStyledAttributes.getBoolean(C2015R.styleable.TwinklingRefreshLayout_tr_overscroll_top_show, true);
            this.isOverScrollBottomShow = typedArrayObtainStyledAttributes.getBoolean(C2015R.styleable.TwinklingRefreshLayout_tr_overscroll_bottom_show, true);
            this.enableOverScroll = typedArrayObtainStyledAttributes.getBoolean(C2015R.styleable.TwinklingRefreshLayout_tr_enable_overscroll, true);
            this.floatRefresh = typedArrayObtainStyledAttributes.getBoolean(C2015R.styleable.TwinklingRefreshLayout_tr_floatRefresh, false);
            this.autoLoadMore = typedArrayObtainStyledAttributes.getBoolean(C2015R.styleable.TwinklingRefreshLayout_tr_autoLoadMore, false);
            this.enableKeepIView = typedArrayObtainStyledAttributes.getBoolean(C2015R.styleable.TwinklingRefreshLayout_tr_enable_keepIView, true);
            this.showRefreshingWhenOverScroll = typedArrayObtainStyledAttributes.getBoolean(C2015R.styleable.TwinklingRefreshLayout_tr_showRefreshingWhenOverScroll, true);
            this.showLoadingWhenOverScroll = typedArrayObtainStyledAttributes.getBoolean(C2015R.styleable.TwinklingRefreshLayout_tr_showLoadingWhenOverScroll, true);
            typedArrayObtainStyledAttributes.recycle();
            this.f804cp = new CoContext();
            addHeader();
            addFooter();
    ...
    private void addHeader() {
        ...
        frameLayout2.setId(C2015R.id.ex_header);
    ...
    protected void onFinishInflate() {
        ...
        this.f804cp.init();
        this.decorator = new OverScrollDecorator(this.f804cp, new RefreshProcessor(this.f804cp));
        initGestureDetector();
    }
    ...
    private void initGestureDetector() {
        this.listener = new OnGestureListener() { // from class: com.lcodecore.tkrefreshlayout.TwinklingRefreshLayout.1
            ...
            public void onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
                TwinklingRefreshLayout.this.decorator.onFingerScroll(motionEvent, motionEvent2, f, f2, TwinklingRefreshLayout.this.f805vx, TwinklingRefreshLayout.this.f806vy);
            }
    ...
    private void detectGesture(MotionEvent motionEvent, OnGestureListener onGestureListener) {
        ...
        if (i == 1) {
            ...
            this.f806vy = this.mVelocityTracker.getYVelocity(pointerId);
            this.f805vx = this.mVelocityTracker.getXVelocity(pointerId);
            if (Math.abs(this.f806vy) > this.mMinimumFlingVelocity || Math.abs(this.f805vx) > this.mMinimumFlingVelocity) {
                onGestureListener.onFling(this.mCurrentDownEvent, motionEvent, this.f805vx, this.f806vy);
            } else {
                z = false;
            }
    ...
    */
    ...
    public void startRefresh() {
        this.f804cp.startRefresh();
    }

    public void startLoadMore() {
        this.f804cp.startLoadMore();
    }

    public void finishRefreshing() {
        this.f804cp.finishRefreshing();
    }

    public void finishLoadmore() {
        this.f804cp.finishLoadmore();
    }
    ...
    @Deprecated
    public void addFixedExHeader(View view2) {
        FrameLayout frameLayout;
        if (view2 == null || (frameLayout = this.mExtraHeadLayout) == null) {
            return;
        }
        ...
        this.f804cp.onAddExHead();
        this.f804cp.setExHeadFixed();
    }
    ...
    public void onFinishRefresh() {
        ...
        if (this.f804cp.isEnableKeepIView() || this.f804cp.isRefreshing()) {
            this.mHeadView.onFinish(new OnAnimEndListener() { // from class: com.lcodecore.tkrefreshlayout.TwinklingRefreshLayout.3
                ...
                public void onAnimEnd() {
                    TwinklingRefreshLayout.this.f804cp.finishRefreshAfterAnim();
                }
            });
        }
    }
    ...
    public void onFinishLoadMore() {
        ...
        if (this.f804cp.isEnableKeepIView() || this.f804cp.isLoadingMore()) {
