...
public class GoogleDotView extends View implements IHeaderView {
    ...
    private void init() {
        this.f807r = DensityUtil.dp2px(getContext(), 4.0f);
        Paint paint = new Paint();
        this.mPath = paint;
        paint.setAntiAlias(true);
        this.mPath.setColor(Color.rgb(114, 114, 114));
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(1.0f, 1.2f, 1.0f, 0.8f);
        this.animator1 = valueAnimatorOfFloat;
        ...
        ValueAnimator valueAnimatorOfFloat2 = ValueAnimator.ofFloat(1.0f, 0.8f, 1.0f, 1.2f);
        this.animator2 = valueAnimatorOfFloat2;
        ...
        for (int i = 0; i < this.num; i++) {
            if (this.animating) {
                if (i == 0) {
                    ...
                    this.mPath.setColor(getResources().getColor(C2015R.color.Yellow));
                    canvas.drawCircle(((getMeasuredWidth() / 2) - (this.cir_x * 2)) - (((measuredWidth * 2) / 3) * 2), getMeasuredHeight() / 2, this.f807r * this.fraction2, this.mPath);
                } else if (i == 1) {
                    this.mPath.setAlpha(145);
                    this.mPath.setColor(getResources().getColor(C2015R.color.Green));
                    canvas.drawCircle(((getMeasuredWidth() / 2) - this.cir_x) - ((measuredWidth / 3) * 2), getMeasuredHeight() / 2, this.f807r * this.fraction2, this.mPath);
                } else if (i == 2) {
                    this.mPath.setAlpha(255);
                    this.mPath.setColor(getResources().getColor(C2015R.color.Blue));
                    canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, this.f807r * this.fraction1, this.mPath);
                } else if (i == 3) {
                    this.mPath.setAlpha(145);
                    this.mPath.setColor(getResources().getColor(C2015R.color.Orange));
                    canvas.drawCircle((getMeasuredWidth() / 2) + this.cir_x + ((measuredWidth / 3) * 2), getMeasuredHeight() / 2, this.f807r * this.fraction2, this.mPath);
                } else if (i == 4) {
                    this.mPath.setAlpha(105);
                    this.mPath.setColor(getResources().getColor(C2015R.color.Yellow));
                ...
                this.mPath.setAlpha(105);
                this.mPath.setColor(getResources().getColor(C2015R.color.Yellow));
                canvas.drawCircle(((getMeasuredWidth() / 2) - (this.cir_x * 2)) - (((measuredWidth * 2) / 3) * 2), getMeasuredHeight() / 2, this.f807r, this.mPath);
            } else if (i == 1) {
                this.mPath.setAlpha(145);
                this.mPath.setColor(getResources().getColor(C2015R.color.Green));
                canvas.drawCircle(((getMeasuredWidth() / 2) - this.cir_x) - ((measuredWidth / 3) * 2), getMeasuredHeight() / 2, this.f807r, this.mPath);
            } else if (i == 2) {
                this.mPath.setAlpha(255);
                this.mPath.setColor(getResources().getColor(C2015R.color.Blue));
                canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, this.f807r, this.mPath);
            } else if (i == 3) {
                this.mPath.setAlpha(145);
                this.mPath.setColor(getResources().getColor(C2015R.color.Orange));
                canvas.drawCircle((getMeasuredWidth() / 2) + this.cir_x + ((measuredWidth / 3) * 2), getMeasuredHeight() / 2, this.f807r, this.mPath);
