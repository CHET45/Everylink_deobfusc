...
public class SinaRefreshView extends FrameLayout implements IHeaderView {
    ...
    private void init() {
        View viewInflate = View.inflate(getContext(), C2015R.layout.view_sinaheader, null);
        this.refreshArrow = (ImageView) viewInflate.findViewById(C2015R.id.iv_arrow);
        this.refreshTextView = (TextView) viewInflate.findViewById(C2015R.id.f803tv);
        this.loadingView = (ImageView) viewInflate.findViewById(C2015R.id.iv_loading);
        addView(viewInflate);
    }
