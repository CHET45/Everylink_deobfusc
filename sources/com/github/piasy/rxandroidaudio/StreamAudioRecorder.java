                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (this.mAudioFormat == 2) {
                            int i = this.mAudioRecord.read(this.mShortBuffer, 0, this.mShortBufferSize);
                            if (i > 0) {
                                this.mAudioDataCallback.onAudioData(short2byte(this.mShortBuffer, i, this.mByteBuffer), i * 2);
                            } else {
                                onError(i);
                                break;
                            }
                        } else {
                            int i2 = this.mAudioRecord.read(this.mByteBuffer, 0, this.mByteBufferSize);
                            if (i2 > 0) {
                                this.mAudioDataCallback.onAudioData(this.mByteBuffer, i2);
                            } else {
                                onError(i2);
                                break;
                            }
