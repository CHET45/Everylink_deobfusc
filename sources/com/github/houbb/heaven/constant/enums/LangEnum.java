...
public enum LangEnum {
    AUTO_DETECT(DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "自动匹配"),
    EN("en", " 英文"),
    EN_US("en_US", " 英文 (美国)"),
    AR("ar", " 阿拉伯文"),
    ...
    KO("ko", " 朝鲜文"),
    KO_KR("ko_KR", " 朝鲜文 (南朝鲜)"),
    LT(TableQuery.QueryComparisons.LESS_THAN, " 立陶宛文"),
    ...
    SK(Constants.QueryConstants.SIGNED_KEY, " 斯洛伐克文"),
    SK_SK("sk_SK", " 斯洛伐克文 (斯洛伐克)"),
    SL("sl", " 斯洛文尼亚文"),
    SL_SI("sl_SI", " 斯洛文尼亚文 (斯洛文尼亚)"),
    SQ("sq", " 阿尔巴尼亚文"),
    SQ_AL("sq_AL", " 阿尔巴尼亚文 (阿尔巴尼亚)"),
    SR(Constants.QueryConstants.SIGNED_RESOURCE, " 塞尔维亚文"),
    SR_YU("sr_YU", " 塞尔维亚文 (南斯拉夫)"),
    SV(Constants.QueryConstants.SIGNED_VERSION, " 瑞典文"),
    SV_SE("sv_SE", " 瑞典文 (瑞典)"),
    TH("th", " 泰文"),
    TH_TH("th_TH", " 泰文 (泰国)"),
    TR("tr", " 土耳其文"),
