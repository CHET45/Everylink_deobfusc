...
public class TypeReference<T> {
    ...
    public static final Type LIST_STRING = new TypeReference<List<String>>() { // from class: com.github.houbb.heaven.util.lang.reflect.TypeReference.1
    }.getType();
    ...
    protected TypeReference(Type... typeArr) {
        ...
        for (int i2 = 0; i2 < actualTypeArguments.length; i2++) {
            ...
            if (type instanceof GenericArrayType) {
                actualTypeArguments[i2] = PrimitiveUtil.checkPrimitiveArray((GenericArrayType) type);
            }
