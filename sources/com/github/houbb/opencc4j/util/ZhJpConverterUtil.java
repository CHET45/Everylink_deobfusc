...
public final class ZhJpConverterUtil {
    private static final ZhConvertBootstrap DEFAULT_BOOTSTRAP = ZhConvertBootstrap.newInstance().segment(Segments.jpFastForward()).dataMap(DataMaps.japan()).init();
    private static final ZhConvertBootstrap JP_SELF_BS = ZhConvertBootstrap.newInstance().segment(Segments.jpSelfFastForward()).dataMap(DataMaps.japanSelf()).init();
    ...
    public static String toSimple(String str) {
        return ZhConverterUtil.toSimple(JP_SELF_BS.toSimple(str));
    }

    public static String toTraditional(String str) {
        return JP_SELF_BS.toTraditional(ZhConverterUtil.toTraditional(str));
    }
