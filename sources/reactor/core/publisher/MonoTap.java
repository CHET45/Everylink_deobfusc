...
final class MonoTap<T, STATE> extends InternalMonoOperator<T, T> {
    ...
    MonoTap(Mono<? extends T> mono, SignalListenerFactory<T, STATE> signalListenerFactory) {
        super(mono);
            ...
            try {
                ...
                try {
                    ...
                    if (coreSubscriber instanceof Fuseable.ConditionalSubscriber) {
                        return new FluxTap.TapConditionalSubscriber((Fuseable.ConditionalSubscriber) coreSubscriber, signalListenerCreateListener, contextAddToContext);
                    }
                    return new FluxTap.TapSubscriber(coreSubscriber, signalListenerCreateListener, contextAddToContext);
                } catch (Throwable th) {
