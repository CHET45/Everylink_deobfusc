...
final class MonoPeek<T> extends InternalMonoOperator<T, T> implements SignalPeek<T> {
    ...
    MonoPeek(Mono<? extends T> mono, @Nullable Consumer<? super Subscription> consumer, @Nullable Consumer<? super T> consumer2, @Nullable LongConsumer longConsumer, @Nullable Runnable runnable) {
        super(mono);
    ...
    public CoreSubscriber<? super T> subscribeOrReturn(CoreSubscriber<? super T> coreSubscriber) {
        ...
        return new FluxPeek.PeekSubscriber(coreSubscriber, this);
    }
