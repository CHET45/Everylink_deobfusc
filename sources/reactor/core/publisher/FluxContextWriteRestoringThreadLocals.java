...
final class FluxContextWriteRestoringThreadLocals<T> extends FluxOperator<T, T> {
    ...
    FluxContextWriteRestoringThreadLocals(Flux<? extends T> flux, Function<Context, Context> function) {
        super(flux);
    ...
    static class ContextWriteRestoringThreadLocalsSubscriber<T> implements Fuseable.ConditionalSubscriber<T>, InnerOperator<T, T> {
        ...
        public void onSubscribe(Subscription subscription) {
            ...
            try {
                if (Operators.validate(this.f2105s, subscription)) {
                    this.f2105s = subscription;
