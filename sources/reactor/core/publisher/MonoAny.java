...
final class MonoAny<T> extends MonoFromFluxOperator<T, Boolean> implements Fuseable {
    final Predicate<? super T> predicate;

    MonoAny(Flux<? extends T> flux, Predicate<? super T> predicate) {
        super(flux);
    ...
    public CoreSubscriber<? super T> subscribeOrReturn(CoreSubscriber<? super Boolean> coreSubscriber) {
        return new AnySubscriber(coreSubscriber, this.predicate);
    }
    ...
    static final class AnySubscriber<T> extends Operators.BaseFluxToMonoOperator<T, Boolean> {
        boolean done;
        final Predicate<? super T> predicate;

        AnySubscriber(CoreSubscriber<? super Boolean> coreSubscriber, Predicate<? super T> predicate) {
