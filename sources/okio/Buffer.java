    ...
    */
            ...
            if (cCharAt < 128) {
                ...
                if (cCharAt < 2048) {
                    ...
                    if (cCharAt > 56319 || cCharAt3 < 56320 || cCharAt3 > 57343) {
                        ...
                        writeByte((i7 >> 18) | Command.CMD_CUSTOM);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writeByte((i >> 18) | Command.CMD_CUSTOM);
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m1928of(messageDigest.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m1928of(mac.doFinal());
