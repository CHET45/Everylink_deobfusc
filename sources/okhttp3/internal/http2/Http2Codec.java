...
public final class Http2Codec implements HttpCodec {
    ...
    private static final String f2029TE = "te";
    private static final String TRANSFER_ENCODING = "transfer-encoding";
    private static final List<String> HTTP_2_SKIPPED_REQUEST_HEADERS = Util.immutableList(CONNECTION, HOST, "keep-alive", PROXY_CONNECTION, f2029TE, TRANSFER_ENCODING, "encoding", "upgrade", Header.TARGET_METHOD_UTF8, Header.TARGET_PATH_UTF8, Header.TARGET_SCHEME_UTF8, Header.TARGET_AUTHORITY_UTF8);
    private static final List<String> HTTP_2_SKIPPED_RESPONSE_HEADERS = Util.immutableList(CONNECTION, HOST, "keep-alive", PROXY_CONNECTION, f2029TE, TRANSFER_ENCODING, "encoding", "upgrade");
