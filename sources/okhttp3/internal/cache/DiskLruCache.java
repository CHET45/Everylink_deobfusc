...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private void validateKey(String str) {
        if (!LEGAL_KEY_PATTERN.matcher(str).matches()) {
            throw new IllegalArgumentException("keys must match regex [a-z0-9_-]{1,120}: \"" + str + PunctuationConst.DOUBLE_QUOTES);
        }
    }
    ...
    private final class Entry {
        ...
        Entry(String str) {
            ...
            StringBuilder sbAppend = new StringBuilder(str).append(CharConst.DOT);
