...
public final class Util {
    ...
    public static final Charset ISO_8859_1 = Charset.forName(CharsetNames.CS_ISO_LATIN1);
    private static final Charset UTF_16_BE = Charset.forName(CharsetNames.CS_UTF16BE);
    private static final Charset UTF_16_LE = Charset.forName(CharsetNames.CS_UTF16LE);
    private static final Charset UTF_32_BE = Charset.forName(CharsetNames.CS_UTF32BE);
    private static final Charset UTF_32_LE = Charset.forName(CharsetNames.CS_UTF32LE);
    ...
    public static String canonicalizeHost(String str) {
        ...
        if (str.contains(":")) {
            ...
            throw new AssertionError("Invalid IPv6 address: '" + str + PunctuationConst.SINGLE_QUOTES);
        }
        try {
