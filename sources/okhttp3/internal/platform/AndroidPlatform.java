...
class AndroidPlatform extends Platform {
    ...
    static final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
        ...
        public List<Certificate> clean(List<Certificate> list, String str) throws SSLPeerUnverifiedException {
            try {
                return (List) this.checkServerTrusted.invoke(this.x509TrustManagerExtensions, (X509Certificate[]) list.toArray(new X509Certificate[list.size()]), RSAUtil.RSA, str);
            } catch (IllegalAccessException e) {
    ...
    static final class CloseGuard {
        ...
        static CloseGuard get() {
            ...
            try {
                ...
                method = cls.getMethod(MethodConst.GET_PREFIX, new Class[0]);
