...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    */
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            if (iCode == 407) {
                ...
                if (com.lzy.okgo.model.HttpHeaders.HEAD_VALUE_CONNECTION_CLOSE.equalsIgnoreCase(responseBuild.header("Connection"))) {
    ...
    private Request createTunnelRequest() throws IOException {
        ...
        Request requestAuthenticate = this.route.address().proxyAuthenticator().authenticate(this.route, new Response.Builder().request(requestBuild).protocol(Protocol.HTTP_1_1).code(Constant.EVENT.BLE_GLASS_HOME_TAB).message("Preemptive Authenticate").body(Util.EMPTY_RESPONSE).sentRequestAtMillis(-1L).receivedResponseAtMillis(-1L).header(AuthorizationChallengeHandler.PROXY_AUTHENTICATE, "OkHttp-Preemptive").build());
