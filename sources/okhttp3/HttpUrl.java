        ...
        Builder parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (iSchemeDelimiterOffset != -1) {
                if (str.regionMatches(true, iSkipLeadingAsciiWhitespace, "https:", 0, 6)) {
                    ...
                    throw new IllegalArgumentException("Expected URL scheme 'http' or 'https' but was '" + str.substring(0, iSchemeDelimiterOffset) + PunctuationConst.SINGLE_QUOTES);
                }
                ...
                while (true) {
                    ...
                    if (bCharAt == 64) {
                        if (z) {
                            ...
                            int iDelimiterOffset2 = Util.delimiterOffset(str, i2, iDelimiterOffset, CharConst.COLON);
                            i = iDelimiterOffset;
