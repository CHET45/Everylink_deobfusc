    ...
    private static final class Entry {
            ...
            try {
                ...
                if (isHttps()) {
                    ...
                    if (utf8LineStrict.length() > 0) {
                        throw new IOException("expected \"\" but was \"" + utf8LineStrict + PunctuationConst.DOUBLE_QUOTES);
                    }
        ...
        private void writeCertList(BufferedSink bufferedSink, List<Certificate> list) throws IOException {
            try {
                ...
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    bufferedSink.writeUtf8(ByteString.m1928of(list.get(i).getEncoded()).base64()).writeByte(10);
                }
    ...
    static int readInt(BufferedSource bufferedSource) throws IOException {
        try {
            ...
            if (decimalLong < 0 || decimalLong > 2147483647L || !utf8LineStrict.isEmpty()) {
                throw new IOException("expected an int but was \"" + decimalLong + utf8LineStrict + PunctuationConst.DOUBLE_QUOTES);
            }
